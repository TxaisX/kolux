...
//
declare const KOLUX_BUILD_IDENTITY: 'stable' | 'rc' | null
declare const KOLUX_POSTHOG_WRITE_KEY: string | null
...
// `KOLUX_DIAGNOSTICS_TOKEN_URL` env var, which env wins so a developer can
// point a packaged build at a staging server without re-running the
// release pipeline.
declare const KOLUX_DIAGNOSTICS_TOKEN_URL: string | null
