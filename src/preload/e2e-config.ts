...
export const preloadE2EConfig = createE2EConfig({
  headless: process.env.KOLUX_E2E_HEADLESS === '1',
  exposeStore,
  userDataDir: process.env.KOLUX_E2E_USER_DATA_DIR ?? null,
  ...
  terminalParkingDelayMs: Number(process.env.KOLUX_E2E_TERMINAL_PARKING_DELAY_MS) || null,
  terminalRetentionLimit: Number(process.env.KOLUX_E2E_TERMINAL_RETENTION_LIMIT) || null
})
