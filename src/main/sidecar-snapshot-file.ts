// Why a sidecar next to kolux-data.json: scan snapshots rewrite wholesale and can reach hundreds
// of KB; folding them into kolux-data.json would rewrite the whole state file per scan (the
