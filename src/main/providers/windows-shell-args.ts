...
export const KOLUX_CODEX_LAUNCH_PREFLIGHT_CMD_QUOTE_ENV = 'KOLUX_CODEX_LAUNCH_PREFLIGHT_CMD_QUOTE'
const CMD_CODEX_LAUNCH_PREFLIGHT = `if defined KOLUX_CODEX_LAUNCH_PREFLIGHT call %${KOLUX_CODEX_LAUNCH_PREFLIGHT_CMD_QUOTE_ENV}%%KOLUX_CODEX_LAUNCH_PREFLIGHT%%${KOLUX_CODEX_LAUNCH_PREFLIGHT_CMD_QUOTE_ENV}% agent hooks prepare-codex > nul 2>&1`
...
function buildWslShellArgs(linuxCwd: string, distro?: string): string[] {
  ...
  // login shell so terminal PATH matches the environment Kolux detects.
