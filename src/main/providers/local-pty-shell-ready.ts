 ...
 * that point each shell at its Kolux wrapper (which emits the OSC 777 marker the scanner detects).
 */
...
/** Args that point bash at Kolux's rcfile, or null when it is not usable. */
