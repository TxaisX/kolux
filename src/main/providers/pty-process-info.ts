...
export type PtyProcessInfo = {
  ...
  worktreeId?: string
  /** Trusted KOLUX_TERMINAL_HANDLE exported into this PTY, when known. */
  ...
  hostAgeMs?: number
  /** True when the host spawned this PTY for a Kolux pane, false for a bare host shell. Absent from
