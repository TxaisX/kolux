...
// ANSI/OSC strippers mirror the runtime normalizer in src/main/runtime/kolux-runtime.ts, plus URL-specific cursor-move handling to avoid fusing skipped text.
