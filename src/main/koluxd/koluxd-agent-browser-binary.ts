...
export function koluxdAgentBrowserNativeName(
...
export function resolveKoluxdAgentBrowserBinary(): string | null {
  const name = koluxdAgentBrowserNativeName(platform(), arch())
  const candidates = [
