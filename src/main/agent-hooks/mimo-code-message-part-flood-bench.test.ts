/**
 * Benchmark-style regression test for the MiMo Code MessagePart flood.
 *
...
// part updates (MiMo Code re-publishes the whole part per append).
...
describe('MiMo Code MessagePart flood benchmark', () => {
