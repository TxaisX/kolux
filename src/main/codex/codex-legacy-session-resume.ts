...
const RETRYABLE_RESUME_ERROR =
  'Kolux could not safely move this legacy Codex session into your system Codex home. Retry resume; if it still fails, check that both Codex session folders are readable and writable.'
