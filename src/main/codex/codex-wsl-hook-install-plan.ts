...
const WSL_PATH_MISSING_OUTPUT = '__KOLUX_WSL_PATH_MISSING__'
...
export function createCodexWslRuntimeHookInstallPlan(
  ...
  return {
    ...
    scriptPath: pathWin32.join(runtimeHomePath, '.kolux', 'agent-hooks', 'codex-hook.sh'),
    commandScriptPath: pathPosix.join(linuxRuntimeHome, '.kolux', 'agent-hooks', 'codex-hook.sh'),
