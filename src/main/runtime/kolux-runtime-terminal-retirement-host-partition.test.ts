...
function syncSshSplit(runtime: KoluxRuntimeService, snapshot: RuntimeMobileSessionTabsSnapshot) {
...
describe('KoluxRuntimeService terminal retirement host partitioning (STA-3463)', () => {
  ...
  it('waits for provider retirement on a direct worktree stop', async () => {
    ...
    const runtime = new KoluxRuntimeService(harness.store)
