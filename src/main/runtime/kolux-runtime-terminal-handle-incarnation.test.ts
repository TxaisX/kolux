...
function makeRuntime(): { runtime: KoluxRuntimeService; writes: string[] } {
  const writes: string[] = []
...
function syncGraph(runtime: KoluxRuntimeService): void {
...
function register(runtime: KoluxRuntimeService, incarnationId: string): void {
