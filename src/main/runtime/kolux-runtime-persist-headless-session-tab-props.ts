...
import { KoluxRuntimeWithCloseHeadlessMobileTerminalTab } from './kolux-runtime-close-headless-mobile-terminal-tab'
...
export class KoluxRuntimeWithPersistHeadlessSessionTabProps extends KoluxRuntimeWithCloseHeadlessMobileTerminalTab {
