...
import { KoluxRuntimeWithStructuredAgentSessionReproveTuiOwner } from './kolux-runtime-structured-agent-session-reprove-tui-owner'
...
export class KoluxRuntimeWithStructuredAgentSessionRecoverTuiOwner extends KoluxRuntimeWithStructuredAgentSessionReproveTuiOwner {
