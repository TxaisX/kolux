...
import { KoluxRuntimeWithCaptureProviderTerminalBuffer } from './kolux-runtime-capture-provider-terminal-buffer'
...
import { projectTerminalVisibleLines } from './kolux-runtime-terminal-projection'
import { HeadlessEmulator } from '../daemon/headless-emulator'
import { withTimeout } from './runtime-async-boundaries'

export class KoluxRuntimeWithVisibleSnapshotPreview extends KoluxRuntimeWithCaptureProviderTerminalBuffer {
