...
import { KoluxRuntimeWithStructuredAgentSessionLaunchTui } from './kolux-runtime-structured-agent-session-launch-tui'
...
export class KoluxRuntimeWithStructuredAgentSessionReproveTuiOwner extends KoluxRuntimeWithStructuredAgentSessionLaunchTui {
