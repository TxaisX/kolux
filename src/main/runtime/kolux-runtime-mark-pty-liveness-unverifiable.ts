...
import { KoluxRuntimeWithOnPtyExit } from './kolux-runtime-on-pty-exit'
...
export class KoluxRuntimeWithMarkPtyLivenessUnverifiable extends KoluxRuntimeWithOnPtyExit {
  /**
  ...
  /**
   * Records that Kolux asked this PTY to stop — a close, a stop, a teardown.
   *
