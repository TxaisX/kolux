...
import { KoluxRuntimeWithFocusTerminal } from './kolux-runtime-focus-terminal'
import { EXPLICIT_TERMINAL_CLOSE_STOP_TIMEOUT_MS } from './kolux-runtime-core'
...
export class KoluxRuntimeWithStopExplicitlyClosedTabPtys extends KoluxRuntimeWithFocusTerminal {
