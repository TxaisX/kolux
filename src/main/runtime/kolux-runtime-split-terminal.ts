...
import { KoluxRuntimeWithStopExplicitlyClosedTabPtys } from './kolux-runtime-stop-explicitly-closed-tab-ptys'
import type { TerminalPaneSplitSource } from '../../shared/feature-education-telemetry'
import type { RuntimeTerminalSplit } from '../../shared/runtime-types'
import { randomUUID } from 'node:crypto'

export class KoluxRuntimeWithSplitTerminal extends KoluxRuntimeWithStopExplicitlyClosedTabPtys {
  async splitTerminal(
    handle: string,
    opts: {
