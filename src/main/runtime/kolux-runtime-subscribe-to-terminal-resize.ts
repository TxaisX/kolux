...
import { KoluxRuntimeWithApplyMobileDisplayMode } from './kolux-runtime-apply-mobile-display-mode'
...
export class KoluxRuntimeWithSubscribeToTerminalResize extends KoluxRuntimeWithApplyMobileDisplayMode {
