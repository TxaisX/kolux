...
import { KoluxRuntimeWithScheduleMobileSessionTabsChanged } from './kolux-runtime-schedule-mobile-session-tabs-changed'
...
export class KoluxRuntimeWithPruneMobileSessionTabGroupLayout extends KoluxRuntimeWithScheduleMobileSessionTabsChanged {
