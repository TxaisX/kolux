...
import { KoluxRuntimeWithResolveTerminalPane } from './kolux-runtime-resolve-terminal-pane'
import { PROVEN_ABSENT_LEAF_PTY_TTL_MS } from './kolux-runtime-core'
...
export class KoluxRuntimeWithControllerKnowsPtyIsLive extends KoluxRuntimeWithResolveTerminalPane {
