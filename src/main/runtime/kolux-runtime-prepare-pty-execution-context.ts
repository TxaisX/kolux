...
import { KoluxRuntimeWithRegisterPty } from './kolux-runtime-register-pty'
...
export class KoluxRuntimeWithPreparePtyExecutionContext extends KoluxRuntimeWithRegisterPty {
