...
import { KoluxRuntimeWithApplyTrackedPtyTitle } from './kolux-runtime-apply-tracked-pty-title'
import type {
...
export class KoluxRuntimeWithCreateTerminalSideEffectCommandCodeDetector extends KoluxRuntimeWithApplyTrackedPtyTitle {
