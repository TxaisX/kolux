...
import { KoluxRuntimeWithRemoveManagedWorktree } from './kolux-runtime-remove-managed-worktree'
...
export class KoluxRuntimeWithResolveWorktreeRemovalTarget extends KoluxRuntimeWithRemoveManagedWorktree {
