...
import { KoluxRuntimeWithHydrateHeadlessMobileSessionTabsFromWorkspaceSession } from './kolux-runtime-hydrate-headless-mobile-session-tabs-from-workspace-session'
import type {
...
import { SSH_PANE_RECOVERY_GRACE_MS } from './kolux-runtime-core'
import { findTerminalTabIdForLeaf } from './workspace-session-terminal-membership-authority'

export class KoluxRuntimeWithReconcileHeadlessMobileSessionBrowserTabs extends KoluxRuntimeWithHydrateHeadlessMobileSessionTabsFromWorkspaceSession {
