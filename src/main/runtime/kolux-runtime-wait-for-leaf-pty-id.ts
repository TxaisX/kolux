...
import { KoluxRuntimeWithRestoreLivePairedRendererSessionOwnedMobileTerminals } from './kolux-runtime-restore-live-paired-renderer-session-owned-mobile-terminals'
import type { TerminalOscLinkRange } from '../../shared/terminal-osc-link-ranges'

export class KoluxRuntimeWithWaitForLeafPtyId extends KoluxRuntimeWithRestoreLivePairedRendererSessionOwnedMobileTerminals {
