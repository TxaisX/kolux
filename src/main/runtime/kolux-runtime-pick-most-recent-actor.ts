...
import { KoluxRuntimeWithReclaimTerminalForDesktop } from './kolux-runtime-reclaim-terminal-for-desktop'
import type { ApplyLayoutResult, PtyLayoutState, PtyLayoutTarget } from './kolux-runtime-core'

export class KoluxRuntimeWithPickMostRecentActor extends KoluxRuntimeWithReclaimTerminalForDesktop {
