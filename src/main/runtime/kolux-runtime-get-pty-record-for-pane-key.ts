...
import { KoluxRuntimeWithPruneMobileSessionTabGroupLayout } from './kolux-runtime-prune-mobile-session-tab-group-layout'
...
export class KoluxRuntimeWithGetPtyRecordForPaneKey extends KoluxRuntimeWithPruneMobileSessionTabGroupLayout {
