...
import { KoluxRuntimeWithSyncMobileSessionTabs } from './kolux-runtime-sync-mobile-session-tabs'
import type {
...
export class KoluxRuntimeWithMergePreservedHeadlessMobileSessionTabs extends KoluxRuntimeWithSyncMobileSessionTabs {
