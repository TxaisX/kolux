...
import { KoluxRuntimeWithRefuseUnattributedMobileSessionTabClose } from './kolux-runtime-refuse-unattributed-mobile-session-tab-close'
import type {
...
export class KoluxRuntimeWithCloseMobileSessionTab extends KoluxRuntimeWithRefuseUnattributedMobileSessionTabClose {
