...
import { KoluxRuntimeWithCreateTerminalSideEffectCommandCodeDetector } from './kolux-runtime-create-terminal-side-effect-command-code-detector'
import type { AgentStatus } from '../../shared/agent-detection'
import { findLastCompleteOscTitleRange } from './kolux-runtime-core'
...
export class KoluxRuntimeWithRecordAgentPromptLifecycleState extends KoluxRuntimeWithCreateTerminalSideEffectCommandCodeDetector {
