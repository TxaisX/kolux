...
import { KoluxRuntimeWithMergePreservedHeadlessMobileSessionTabs } from './kolux-runtime-merge-preserved-headless-mobile-session-tabs'
import type {
...
export class KoluxRuntimeWithStoredMobileSnapshotHasStalePreservedTab extends KoluxRuntimeWithMergePreservedHeadlessMobileSessionTabs {
