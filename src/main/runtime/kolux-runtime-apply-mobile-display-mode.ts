...
import { KoluxRuntimeWithHandleMobileUnsubscribe } from './kolux-runtime-handle-mobile-unsubscribe'

export class KoluxRuntimeWithApplyMobileDisplayMode extends KoluxRuntimeWithHandleMobileUnsubscribe {
