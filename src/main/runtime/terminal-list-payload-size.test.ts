...
const WORKTREE_PATH = '/Users/dev/kolux/workspaces/kolux/perf-terminal-list-diet'
...
const titleFor = (index: number): string => `claude — kolux/perf-terminal-list-diet #${index}`
...
function buildLoadedRuntime(): KoluxRuntimeService {
