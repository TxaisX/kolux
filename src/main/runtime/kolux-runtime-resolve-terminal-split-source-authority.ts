...
import { KoluxRuntimeWithSplitPtyBackedTerminal } from './kolux-runtime-split-pty-backed-terminal'
import {
...
export class KoluxRuntimeWithResolveTerminalSplitSourceAuthority extends KoluxRuntimeWithSplitPtyBackedTerminal {
  ...
  async prepareClaudeAgentTeamsLeader(args: {
    ...
    if (!handle) {
      throw new Error('claude_agent_teams_requires_kolux_terminal')
    }
