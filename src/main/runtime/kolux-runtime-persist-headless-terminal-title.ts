...
import { KoluxRuntimeWithMoveHeadlessMobileSessionTab } from './kolux-runtime-move-headless-mobile-session-tab'
import type {
...
export class KoluxRuntimeWithPersistHeadlessTerminalTitle extends KoluxRuntimeWithMoveHeadlessMobileSessionTab {
