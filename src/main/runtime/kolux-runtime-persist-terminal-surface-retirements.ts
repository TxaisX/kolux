...
import { KoluxRuntimeWithTouchMobileSessionTabsForWorktree } from './kolux-runtime-touch-mobile-session-tabs-for-worktree'
...
export class KoluxRuntimeWithPersistTerminalSurfaceRetirements extends KoluxRuntimeWithTouchMobileSessionTabsForWorktree {
  /**
