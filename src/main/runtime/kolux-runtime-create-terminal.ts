...
import { KoluxRuntimeWithTerminalCreateDeduplication } from './kolux-runtime-terminal-create-deduplication'
import * as dependencies from './kolux-runtime-create-terminal-dependencies'
import { createDesktopTerminal } from './kolux-runtime-create-terminal-desktop'
import { buildRuntimeAgentTeamsLaunchPlan } from './kolux-runtime-agent-teams-launch-plan'
import { createPtySpawnCommitReporter } from './kolux-runtime-report-pty-spawn-commit'

export class KoluxRuntimeWithCreateTerminal extends KoluxRuntimeWithTerminalCreateDeduplication {
  async createTerminal(
    ...
    if (shouldCreateInBackground) {
      ...
      try {
        ...
        const baseEnv = {
          ...launchOpts.env,
          ...(launchToken ? { KOLUX_AGENT_LAUNCH_TOKEN: launchToken } : {})
        }
