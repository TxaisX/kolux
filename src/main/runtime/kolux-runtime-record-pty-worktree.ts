...
import { KoluxRuntimeWithRefreshRepoWorktreeScan } from './kolux-runtime-refresh-repo-worktree-scan'
...
export class KoluxRuntimeWithRecordPtyWorktree extends KoluxRuntimeWithRefreshRepoWorktreeScan {
