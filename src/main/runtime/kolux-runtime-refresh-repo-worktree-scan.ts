...
import { KoluxRuntimeWithListKnownResolvedWorktreesForExplicitTarget } from './kolux-runtime-list-known-resolved-worktrees-for-explicit-target'
import type { Repo } from '../../shared/repo-types'
import type { ProjectExecutionRuntimeResolution } from '../../shared/project-execution-runtime'
import type { RuntimeWorktreeScanCache, RuntimeWorktreeScanRefresh } from './kolux-runtime-core'
...
export class KoluxRuntimeWithRefreshRepoWorktreeScan extends KoluxRuntimeWithListKnownResolvedWorktreesForExplicitTarget {
  /**
