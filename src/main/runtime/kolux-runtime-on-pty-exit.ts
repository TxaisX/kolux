...
import { KoluxRuntimeWithOnClientDisconnected } from './kolux-runtime-on-client-disconnected'
...
export class KoluxRuntimeWithOnPtyExit extends KoluxRuntimeWithOnClientDisconnected {
  onPtyExit(
    ptyId: string,
    exitCode: number,
