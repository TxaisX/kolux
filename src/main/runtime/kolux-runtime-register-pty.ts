...
import { KoluxRuntimeWithInvalidateAllHandlesForPty } from './kolux-runtime-invalidate-all-handles-for-pty'
...
export class KoluxRuntimeWithRegisterPty extends KoluxRuntimeWithInvalidateAllHandlesForPty {
  registerPty(
    ptyId: string,
    worktreeId: string,
