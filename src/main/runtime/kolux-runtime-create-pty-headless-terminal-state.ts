...
import { KoluxRuntimeWithMaybeHydrateHeadlessFromRenderer } from './kolux-runtime-maybe-hydrate-headless-from-renderer'
...
export class KoluxRuntimeWithCreatePtyHeadlessTerminalState extends KoluxRuntimeWithMaybeHydrateHeadlessFromRenderer {
