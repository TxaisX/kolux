...
import { KoluxRuntimeWithStopStructuredSessionProcess } from './kolux-runtime-stop-structured-session-process'
...
export class KoluxRuntimeWithResolveRecoveredStructuredTuiTranscript extends KoluxRuntimeWithStopStructuredSessionProcess {
