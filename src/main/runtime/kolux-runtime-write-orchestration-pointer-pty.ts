...
import { KoluxRuntimeWithRefreshFloatingWorkspacePtyLiveness } from './kolux-runtime-refresh-floating-workspace-pty-liveness'
...
export class KoluxRuntimeWithWriteOrchestrationPointerPty extends KoluxRuntimeWithRefreshFloatingWorkspacePtyLiveness {
