...
import { HEADLESS_RUNTIME_WINDOW_ID, KoluxRuntimeService } from '../kolux-runtime-test-mocks.spec'
import type { RuntimeClientEvent } from '../kolux-runtime-test-mocks.spec'
import {
  TEST_REPO_ID,
  TEST_WORKTREE_ID,
  store,
...
import { createSideEffectRuntime } from '../kolux-runtime-test-scenario-builders.spec'
...
describe('terminal side-effect fact channel', () => {
  ...
  it('emits pr-link facts once per URL with batch attribution', () => {
    ...
    runtime.onPtyData('pty-1', 'PR https://github.com/acme/kolux/pull/4', 100)
    runtime.onPtyData('pty-1', '2\r\nand https://github.com/acme/kolux/pull/43 done\r\n', 101)
    // Repeated URL: deduped per PTY, like the renderer byte detector.
    runtime.onPtyData('pty-1', 'again https://github.com/acme/kolux/pull/42\r\n', 102)
