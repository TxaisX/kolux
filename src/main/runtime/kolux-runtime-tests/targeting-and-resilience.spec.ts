...
import { createMobileCreateTestNotifier } from '../kolux-runtime-test-scenario-builders.spec'
...
describe('KoluxRuntimeService', () => {
  ...
  describe('stale terminal handle resolution (#7718)', () => {
    function syncSingleTerminalGraph(runtime: KoluxRuntimeService, ptyId: string): void {
    ...
    function issueLeafHandle(runtime: KoluxRuntimeService, ptyId: string): string {
