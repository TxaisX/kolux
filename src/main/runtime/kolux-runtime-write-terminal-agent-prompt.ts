...
import { KoluxRuntimeWithResolveAuthoritativeTerminalWaitPermission } from './kolux-runtime-resolve-authoritative-terminal-wait-permission'
...
export class KoluxRuntimeWithWriteTerminalAgentPrompt extends KoluxRuntimeWithResolveAuthoritativeTerminalWaitPermission {
  protected async writeTerminalAgentPrompt(
    ...
    // receipt; they must not fail a Dispatch merely because Kolux cannot prove
