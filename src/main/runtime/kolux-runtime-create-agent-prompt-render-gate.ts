...
import { KoluxRuntimeWithWriteTerminalAgentPrompt } from './kolux-runtime-write-terminal-agent-prompt'
import {
...
export class KoluxRuntimeWithCreateAgentPromptRenderGate extends KoluxRuntimeWithWriteTerminalAgentPrompt {
