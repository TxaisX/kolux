...
import { KoluxRuntimeWithResolveKnownWorkspaceFileTarget } from './kolux-runtime-resolve-known-workspace-file-target'
import type { PtyIncarnationId } from '../../shared/pty-incarnation'

export class KoluxRuntimeWithInvalidateAllHandlesForPty extends KoluxRuntimeWithResolveKnownWorkspaceFileTarget {
