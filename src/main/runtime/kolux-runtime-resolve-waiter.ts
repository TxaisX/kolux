...
import { KoluxRuntimeWithDeliverPendingMessages } from './kolux-runtime-deliver-pending-messages'
...
export class KoluxRuntimeWithResolveWaiter extends KoluxRuntimeWithDeliverPendingMessages {
