...
import { KoluxRuntimeWithResolveMobileSessionTerminalCommand } from './kolux-runtime-resolve-mobile-session-terminal-command'
...
export class KoluxRuntimeWithCreateRuntimeOwnedMobileSessionTerminal extends KoluxRuntimeWithResolveMobileSessionTerminalCommand {
