...
import { KoluxRuntimeWithVisibleSnapshotPreview } from './kolux-runtime-visible-snapshot-preview'
...
export class KoluxRuntimeWithSerializeHeadlessTerminalBuffer extends KoluxRuntimeWithVisibleSnapshotPreview {
