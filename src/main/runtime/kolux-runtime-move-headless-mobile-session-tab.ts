...
import { KoluxRuntimeWithPersistHeadlessSessionTabProps } from './kolux-runtime-persist-headless-session-tab-props'
import type {
...
export class KoluxRuntimeWithMoveHeadlessMobileSessionTab extends KoluxRuntimeWithPersistHeadlessSessionTabProps {
