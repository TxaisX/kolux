...
import { KoluxRuntimeWithSerializeTerminalBufferFromAvailableState } from './kolux-runtime-serialize-terminal-buffer-from-available-state'
...
import type { RuntimeTerminalProjection } from './kolux-runtime-core'
import { DEFAULT_TERMINAL_READ_LIMIT } from './terminal-tail-limits'
import { HeadlessEmulator } from '../daemon/headless-emulator'
import { projectTerminalTailLines } from './kolux-runtime-terminal-projection'

export class KoluxRuntimeWithCaptureProviderTerminalBuffer extends KoluxRuntimeWithSerializeTerminalBufferFromAvailableState {
