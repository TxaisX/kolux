...
import { KoluxRuntimeWithCreateRuntimeOwnedMobileSessionTerminal } from './kolux-runtime-create-runtime-owned-mobile-session-terminal'
import type {
  RuntimeMobileSessionCreateTerminalResult,
  RuntimeMobileSessionTerminalClientTab
} from '../../shared/runtime-types'
import { MOBILE_TERMINAL_SURFACE_TIMEOUT_MS } from './kolux-runtime-core'
...
export class KoluxRuntimeWithWaitForMobileTerminalSurface extends KoluxRuntimeWithCreateRuntimeOwnedMobileSessionTerminal {
