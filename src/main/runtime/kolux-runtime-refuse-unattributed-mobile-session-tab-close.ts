...
import { KoluxRuntimeWithApplyMobileSessionTabNavigation } from './kolux-runtime-apply-mobile-session-tab-navigation'
import type { RuntimeMobileSessionTabCloseResult } from '../../shared/runtime-types'

export class KoluxRuntimeWithRefuseUnattributedMobileSessionTabClose extends KoluxRuntimeWithApplyMobileSessionTabNavigation {
