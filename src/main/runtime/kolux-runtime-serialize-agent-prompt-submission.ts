...
import { KoluxRuntimeWithControllerKnowsPtyIsLive } from './kolux-runtime-controller-knows-pty-is-live'
...
export class KoluxRuntimeWithSerializeAgentPromptSubmission extends KoluxRuntimeWithControllerKnowsPtyIsLive {
