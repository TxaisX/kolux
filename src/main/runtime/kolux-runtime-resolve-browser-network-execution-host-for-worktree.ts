...
import { KoluxRuntimeWithTransitionGraphReloadToTerminalState } from './kolux-runtime-transition-graph-reload-to-terminal-state'
...
import type { ResolvedTerminalWorkspaceLaunchTarget } from './kolux-runtime-core'
import { AGENT_HOOK_RUNTIME_ENV_KEYS } from './kolux-runtime-core'
...
export class KoluxRuntimeWithResolveBrowserNetworkExecutionHostForWorktree extends KoluxRuntimeWithTransitionGraphReloadToTerminalState {
  ...
  protected buildTerminalWorkspaceEnv(
    ...
    return {
      ...env,
      KOLUX_WORKSPACE_ID: scope.id,
      KOLUX_PROJECT_GROUP_ID: scope.folderWorkspace.projectGroupId,
      KOLUX_WORKSPACE_ROOT: scope.folderWorkspace.folderPath
    }
  }
