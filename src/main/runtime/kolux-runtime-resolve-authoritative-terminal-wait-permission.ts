...
import { KoluxRuntimeWithAgentPromptRequestCorrelation } from './kolux-runtime-agent-prompt-request-correlation'
...
export class KoluxRuntimeWithResolveAuthoritativeTerminalWaitPermission extends KoluxRuntimeWithAgentPromptRequestCorrelation {
