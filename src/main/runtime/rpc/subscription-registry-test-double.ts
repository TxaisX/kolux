import type { SubscriptionRegistration } from '../kolux-runtime'
...
/**
 * Faithful double of the runtime subscription registry (`KoluxRuntimeService`,
 ...
 * `kolux-runtime.test.ts` are what pin the real behavior; these doubles only pin routing.
 *
