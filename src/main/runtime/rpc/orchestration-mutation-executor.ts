        ...
        throw new OrchestrationError(
          ...
          recovery
            ? {
                ...
                recoveryCommand: `kolux orchestration worker-show --dispatch ${recovery.dispatchId} --json`
              }
            : { requestId }
        )
      }
...
const executorsByRuntime = new WeakMap<KoluxRuntimeService, OrchestrationMutationExecutor>()
