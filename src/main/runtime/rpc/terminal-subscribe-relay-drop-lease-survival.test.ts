...
// a real KoluxRuntimeService, because a relay drop reaches the phone through the predicate.
...
function makeRelayDroppedRuntime(): KoluxRuntimeService {
  const real = new KoluxRuntimeService()
...
function createRuntime(real: KoluxRuntimeService): {
