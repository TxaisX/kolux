...
import { KoluxRuntimeWithGetTerminalInteractiveWait } from './kolux-runtime-get-terminal-interactive-wait'
import type {
  RuntimeTerminalRead,
...
export class KoluxRuntimeWithResolveTerminalPane extends KoluxRuntimeWithGetTerminalInteractiveWait {
