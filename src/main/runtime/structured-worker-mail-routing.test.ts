...
const { KoluxRuntimeWithAdoptTerminalOrphansFromInventory } =
  await import('./kolux-runtime-adopt-terminal-orphans-from-inventory')
const {
...
const prototype = KoluxRuntimeWithAdoptTerminalOrphansFromInventory.prototype
