...
import { KoluxRuntimeWithWaitForLeafPtyId } from './kolux-runtime-wait-for-leaf-pty-id'
...
export class KoluxRuntimeWithFocusTerminal extends KoluxRuntimeWithWaitForLeafPtyId {
  async focusTerminal(
    handle: string,
