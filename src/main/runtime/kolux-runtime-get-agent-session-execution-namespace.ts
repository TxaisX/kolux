...
import { KoluxRuntimeWithResolveWorktreeRemovalTarget } from './kolux-runtime-resolve-worktree-removal-target'
...
export class KoluxRuntimeWithGetAgentSessionExecutionNamespace extends KoluxRuntimeWithResolveWorktreeRemovalTarget {
