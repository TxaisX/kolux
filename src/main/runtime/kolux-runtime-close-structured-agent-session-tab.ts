...
import { KoluxRuntimeWithCloseMobileSessionTab } from './kolux-runtime-close-mobile-session-tab'
import type {
...
export class KoluxRuntimeWithCloseStructuredAgentSessionTab extends KoluxRuntimeWithCloseMobileSessionTab {
