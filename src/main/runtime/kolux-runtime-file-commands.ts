...
import { KoluxRuntimeWithPreservedBranchCleanup } from './kolux-runtime-preserved-branch-cleanup'
import { RuntimeFileCommands } from './kolux-runtime-files'
...
export class KoluxRuntimeWithFileCommands extends KoluxRuntimeWithPreservedBranchCleanup {
