...
import { KoluxRuntimeWithAutomationOperations } from './kolux-runtime-automation-operations'
import {
...
export class KoluxRuntimeWithHasExactPersistedTerminalSurfaceIdentity extends KoluxRuntimeWithAutomationOperations {
