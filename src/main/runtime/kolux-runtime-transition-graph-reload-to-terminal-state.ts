...
import { KoluxRuntimeWithHasTerminalsForWorktree } from './kolux-runtime-has-terminals-for-worktree'
...
export class KoluxRuntimeWithTransitionGraphReloadToTerminalState extends KoluxRuntimeWithHasTerminalsForWorktree {
