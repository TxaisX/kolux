...
// Why: dedicated file for "one surface" separation (emulator), parallel to kolux-runtime-browser.ts. Keeps KoluxRuntimeService focused; emulator routing easy to scan. No max-lines disable (split further if grows; per AGENTS + plan Phase 3).
...
export class RuntimeEmulatorCommands {
  ...
  // devices/AVDs) for the cross-platform `kolux emulator devices` command.
