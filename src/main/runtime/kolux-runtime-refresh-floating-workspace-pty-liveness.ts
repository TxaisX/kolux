...
import { KoluxRuntimeWithRefreshPtyWorktreeRecordsWithControllerInventory } from './kolux-runtime-refresh-pty-worktree-records-with-controller-inventory'
import { FLOATING_TERMINAL_WORKTREE_ID } from '../../shared/constants'
import { isTerminalLeafId, makePaneKey } from '../../shared/stable-pane-id'
import type { RuntimeLeafRecord, RuntimePtyWorktreeRecord } from './runtime-terminal-state-records'
import { DISCONNECTED_PTY_RECORD_MAX } from './kolux-runtime-postlude'

export class KoluxRuntimeWithRefreshFloatingWorkspacePtyLiveness extends KoluxRuntimeWithRefreshPtyWorktreeRecordsWithControllerInventory {
