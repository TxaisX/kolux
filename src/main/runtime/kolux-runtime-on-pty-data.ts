...
import { KoluxRuntimeWithPreparePtyExecutionContext } from './kolux-runtime-prepare-pty-execution-context'
...
export class KoluxRuntimeWithOnPtyData extends KoluxRuntimeWithPreparePtyExecutionContext {
  onPtyData(
    ptyId: string,
    data: string,
    at: number,
