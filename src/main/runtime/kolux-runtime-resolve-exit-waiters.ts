...
import { KoluxRuntimeWithBindPtyIncarnationHandle } from './kolux-runtime-bind-pty-incarnation-handle'
...
export class KoluxRuntimeWithResolveExitWaiters extends KoluxRuntimeWithBindPtyIncarnationHandle {
