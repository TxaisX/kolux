...
import { KoluxRuntimeWithSyncWindowGraph } from './kolux-runtime-sync-window-graph'
...
export class KoluxRuntimeWithCollectMobileVisibleGraphChangedWorktrees extends KoluxRuntimeWithSyncWindowGraph {
  ...
  supportsAuthoritativeSessionTabsInventory(): boolean {
    return process.env.KOLUX_E2E_DISABLE_AUTHORITATIVE_SESSION_TABS_INVENTORY !== '1'
  }
