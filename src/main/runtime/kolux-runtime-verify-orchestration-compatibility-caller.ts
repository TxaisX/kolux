...
import { KoluxRuntimeWithSerializeHeadlessTerminalBuffer } from './kolux-runtime-serialize-headless-terminal-buffer'
import type {
...
export class KoluxRuntimeWithVerifyOrchestrationCompatibilityCaller extends KoluxRuntimeWithSerializeHeadlessTerminalBuffer {
