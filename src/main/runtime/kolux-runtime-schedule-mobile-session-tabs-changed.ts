...
import { KoluxRuntimeWithStoredMobileSnapshotHasStalePreservedTab } from './kolux-runtime-stored-mobile-snapshot-has-stale-preserved-tab'
import type {
  BrowserTabInfo,
...
export class KoluxRuntimeWithScheduleMobileSessionTabsChanged extends KoluxRuntimeWithStoredMobileSnapshotHasStalePreservedTab {
