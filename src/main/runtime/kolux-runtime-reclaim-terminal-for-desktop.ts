...
import { KoluxRuntimeWithMobileTookFloor } from './kolux-runtime-mobile-took-floor'
import {
  MOBILE_AUTO_RESTORE_FIT_MAX_MS,
  MOBILE_AUTO_RESTORE_FIT_MIN_MS
} from './kolux-runtime-postlude'

export class KoluxRuntimeWithReclaimTerminalForDesktop extends KoluxRuntimeWithMobileTookFloor {
