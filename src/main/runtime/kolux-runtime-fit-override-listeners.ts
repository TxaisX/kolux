...
import { KoluxRuntimeWithStopRequestedPtyIds } from './kolux-runtime-stop-requested-pty-ids'
...
export class KoluxRuntimeWithFitOverrideListeners extends KoluxRuntimeWithStopRequestedPtyIds {
