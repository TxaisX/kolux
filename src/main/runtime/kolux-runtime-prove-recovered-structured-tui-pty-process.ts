...
import { KoluxRuntimeWithGetWorktreePs } from './kolux-runtime-get-worktree-ps'
...
export class KoluxRuntimeWithProveRecoveredStructuredTuiPtyProcess extends KoluxRuntimeWithGetWorktreePs {
