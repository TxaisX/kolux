...
import { KoluxRuntimeWithHasRecentTerminalOutputPath } from './kolux-runtime-has-recent-terminal-output-path'
import type { RuntimeCommandSurfaceHost } from './kolux-runtime-core'

export class KoluxRuntimeWithOnClientDisconnected extends KoluxRuntimeWithHasRecentTerminalOutputPath {
