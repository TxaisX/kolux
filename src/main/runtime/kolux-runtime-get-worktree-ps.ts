...
import { KoluxRuntimeWithStructuredAgentSessionRecoverTuiOwner } from './kolux-runtime-structured-agent-session-recover-tui-owner'
import { DEFAULT_WORKTREE_PS_LIMIT } from './kolux-runtime-postlude'
...
export class KoluxRuntimeWithGetWorktreePs extends KoluxRuntimeWithStructuredAgentSessionRecoverTuiOwner {
  async getWorktreePs(
