...
import { KoluxRuntimeWithPickMostRecentActor } from './kolux-runtime-pick-most-recent-actor'
import type { ApplyLayoutResult, PtyLayoutState, PtyLayoutTarget } from './kolux-runtime-core'

export class KoluxRuntimeWithApplyLayout extends KoluxRuntimeWithPickMostRecentActor {
