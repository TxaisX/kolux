...
import { KoluxRuntimeWithListManagedWorktrees } from './kolux-runtime-list-managed-worktrees'
...
export class KoluxRuntimeWithActivateManagedWorktree extends KoluxRuntimeWithListManagedWorktrees {
  async activateManagedWorktree(
     ...
     *  renderer holds the sleeping records (headless `kolux serve`), so nothing
