...
import { KoluxRuntimeWithRestoreStructuredAgentSessionTabsOnce } from './kolux-runtime-restore-structured-agent-session-tabs-once'
import { DEFAULT_WORKTREE_LIST_LIMIT } from './kolux-runtime-postlude'
...
export class KoluxRuntimeWithListManagedWorktrees extends KoluxRuntimeWithRestoreStructuredAgentSessionTabsOnce {
