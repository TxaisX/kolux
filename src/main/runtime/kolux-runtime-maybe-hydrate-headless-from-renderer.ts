...
import { KoluxRuntimeWithSerializeMainTerminalBuffer } from './kolux-runtime-serialize-main-terminal-buffer'
...
export class KoluxRuntimeWithMaybeHydrateHeadlessFromRenderer extends KoluxRuntimeWithSerializeMainTerminalBuffer {
