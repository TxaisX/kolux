...
import { KoluxRuntimeWithCreateAgentPromptRenderGate } from './kolux-runtime-create-agent-prompt-render-gate'
import type {
...
export class KoluxRuntimeWithStartTuiIdleVisibleReadProbe extends KoluxRuntimeWithCreateAgentPromptRenderGate {
