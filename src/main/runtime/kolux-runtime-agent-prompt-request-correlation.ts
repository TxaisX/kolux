import { KoluxRuntimeWithSerializeAgentPromptSubmission } from './kolux-runtime-serialize-agent-prompt-submission'
...
export class KoluxRuntimeWithAgentPromptRequestCorrelation extends KoluxRuntimeWithSerializeAgentPromptSubmission {
