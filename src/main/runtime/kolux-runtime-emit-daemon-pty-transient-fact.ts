...
import { KoluxRuntimeWithScheduleWaitBlockedCheck } from './kolux-runtime-schedule-wait-blocked-check'
...
export class KoluxRuntimeWithEmitDaemonPtyTransientFact extends KoluxRuntimeWithScheduleWaitBlockedCheck {
  ...
  getTerminalSideEffectSnapshot(ptyId: string): TerminalSideEffectBatch | null {
    ...
    // tracker title Kolux synthesized from hooks — but with no tracker title it is the pane's
