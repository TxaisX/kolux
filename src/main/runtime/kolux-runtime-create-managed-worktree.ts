...
import { KoluxRuntimeWithGetWorktreeTerminalProvisioningHost } from './kolux-runtime-get-worktree-terminal-provisioning-host'
...
export class KoluxRuntimeWithCreateManagedWorktree extends KoluxRuntimeWithGetWorktreeTerminalProvisioningHost {
