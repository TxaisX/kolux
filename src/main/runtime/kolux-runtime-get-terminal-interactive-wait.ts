...
import { KoluxRuntimeWithAdoptTerminalOrphansFromInventory } from './kolux-runtime-adopt-terminal-orphans-from-inventory'
import type {
...
import { TERMINAL_INTERACTIVE_WAIT_PROBE_TIMEOUT_MS } from './kolux-runtime-core'
...
export class KoluxRuntimeWithGetTerminalInteractiveWait extends KoluxRuntimeWithAdoptTerminalOrphansFromInventory {
