...
import { KoluxRuntimeWithStartTuiIdleVisibleReadProbe } from './kolux-runtime-start-tui-idle-visible-read-probe'
...
export class KoluxRuntimeWithStructuredAgentSessionLaunchTui extends KoluxRuntimeWithStartTuiIdleVisibleReadProbe {
