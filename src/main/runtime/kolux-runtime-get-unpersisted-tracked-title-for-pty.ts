...
import { KoluxRuntimeWithEmitDaemonPtyTransientFact } from './kolux-runtime-emit-daemon-pty-transient-fact'
...
export class KoluxRuntimeWithGetUnpersistedTrackedTitleForPty extends KoluxRuntimeWithEmitDaemonPtyTransientFact {
