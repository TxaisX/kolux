...
import { KoluxRuntimeWithApplyLayout } from './kolux-runtime-apply-layout'

export class KoluxRuntimeWithHandleMobileSubscribe extends KoluxRuntimeWithApplyLayout {
