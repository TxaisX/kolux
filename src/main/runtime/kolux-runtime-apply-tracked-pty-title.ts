...
import { KoluxRuntimeWithGetUnpersistedTrackedTitleForPty } from './kolux-runtime-get-unpersisted-tracked-title-for-pty'
...
export class KoluxRuntimeWithApplyTrackedPtyTitle extends KoluxRuntimeWithGetUnpersistedTrackedTitleForPty {
