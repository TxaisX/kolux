...
const { mergeGitLabMRMock, muxRequestMock, parseKoluxYaml, prepareLocalWorktreeRootForRepoMock } =
  mocks
...
function resetRuntimeTestMocks(): void {
  ...
  vi.mocked(parseKoluxYaml).mockReset()
  ...
  vi.mocked(parseKoluxYaml).mockReturnValue(null)
