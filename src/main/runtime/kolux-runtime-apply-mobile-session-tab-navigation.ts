...
import { KoluxRuntimeWithPerformMobileSessionPtyRecordsRefresh } from './kolux-runtime-perform-mobile-session-pty-records-refresh'
import type {
...
export class KoluxRuntimeWithApplyMobileSessionTabNavigation extends KoluxRuntimeWithPerformMobileSessionPtyRecordsRefresh {
