...
import * as setup from './kolux-runtime-test-mocks/setup.spec'
import * as importedValues from './kolux-runtime-test-mocks/imported-values.spec'
...
export const KoluxRuntimeService = importedValues.exportedKoluxRuntimeService
...
export const parseKoluxYaml = importedValues.exportedParseKoluxYaml
...
} from './kolux-runtime-test-mocks/setup.spec'
...
export { electronMocks } from './kolux-runtime-test-mocks/setup.spec'
export {
...
export type KoluxRuntimeService = InstanceType<typeof importedValues.exportedKoluxRuntimeService>
...
export type { RuntimeTerminalAgentStatusEvent } from './kolux-runtime'
