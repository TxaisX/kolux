...
import { KoluxRuntimeWithHasExactPersistedTerminalSurfaceIdentity } from './kolux-runtime-has-exact-persisted-terminal-surface-identity'
import type {
...
export class KoluxRuntimeWithGetRuntimeId extends KoluxRuntimeWithHasExactPersistedTerminalSurfaceIdentity {
  getRuntimeId(): string {
