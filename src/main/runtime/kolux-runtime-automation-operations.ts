...
import { KoluxRuntimeWithPtyForegroundProcessReads } from './kolux-runtime-pty-foreground-process-reads'
import type {
...
export class KoluxRuntimeWithAutomationOperations extends KoluxRuntimeWithPtyForegroundProcessReads {
