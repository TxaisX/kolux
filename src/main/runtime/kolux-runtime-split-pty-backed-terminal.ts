...
import { KoluxRuntimeWithSplitTerminal } from './kolux-runtime-split-terminal'
import type { RuntimePtyWorktreeRecord } from './runtime-terminal-state-records'
import type { TerminalPaneSplitSource } from '../../shared/feature-education-telemetry'
import type { RuntimeTerminalSplit } from '../../shared/runtime-types'
import { makePaneKey, parsePaneKey } from '../../shared/stable-pane-id'
import { randomUUID } from 'node:crypto'
import { REJECTED_SPLIT_PTY_STOP_TIMEOUT_MS, ownerSurfacing } from './kolux-runtime-core'

export class KoluxRuntimeWithSplitPtyBackedTerminal extends KoluxRuntimeWithSplitTerminal {
