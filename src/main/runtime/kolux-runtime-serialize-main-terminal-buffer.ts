...
import { KoluxRuntimeWithAttachRemoteTerminalSourceRangeConsumer } from './kolux-runtime-attach-remote-terminal-source-range-consumer'
...
export class KoluxRuntimeWithSerializeMainTerminalBuffer extends KoluxRuntimeWithAttachRemoteTerminalSourceRangeConsumer {
  ...
  // Why: daemon-backed PTYs that the runtime adopted after a Kolux relaunch
