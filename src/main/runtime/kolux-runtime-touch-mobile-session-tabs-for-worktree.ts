...
import { KoluxRuntimeWithPublishPtyBackedMobileSessionTerminal } from './kolux-runtime-publish-pty-backed-mobile-session-terminal'
...
export class KoluxRuntimeWithTouchMobileSessionTabsForWorktree extends KoluxRuntimeWithPublishPtyBackedMobileSessionTerminal {
