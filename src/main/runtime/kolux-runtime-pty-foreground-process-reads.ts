...
import { KoluxRuntimeWithStateFields } from './kolux-runtime-state-fields'
import {
...
export class KoluxRuntimeWithPtyForegroundProcessReads extends KoluxRuntimeWithStateFields {
