...
import { KoluxRuntimeWithCreatePtyHeadlessTerminalState } from './kolux-runtime-create-pty-headless-terminal-state'
import type { TerminalOscLinkRange } from '../../shared/terminal-osc-link-ranges'
import type { PtyProviderBufferSnapshot } from '../providers/types'
import { withTimeout } from './runtime-async-boundaries'

export class KoluxRuntimeWithSerializeTerminalBufferFromAvailableState extends KoluxRuntimeWithCreatePtyHeadlessTerminalState {
