...
import { KoluxRuntimeWithCreateMobileSessionTerminal } from './kolux-runtime-create-mobile-session-terminal'
...
export class KoluxRuntimeWithRunCreateMobileSessionTerminal extends KoluxRuntimeWithCreateMobileSessionTerminal {
