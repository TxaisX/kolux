...
import { KoluxRuntimeWithPersistHeadlessTerminalTitle } from './kolux-runtime-persist-headless-terminal-title'
import {
...
export class KoluxRuntimeWithResolveKnownWorkspaceFileTarget extends KoluxRuntimeWithPersistHeadlessTerminalTitle {
  ...
  // RPC, but agents need their own handle at spawn time (via KOLUX_TERMINAL_HANDLE
  ...
  protected adoptControllerTerminalHandle(
    ...
    // original KOLUX_TERMINAL_HANDLE, but the runtime's in-memory map is gone.
