/**
 * Executes the generated MiMo Code plugin artifact to verify that descendant
...
describe('MiMo Code plugin child attention', () => {
  let tempDir: string
  ...
  beforeEach(() => {
    tempDir = mkdtempSync(join(tmpdir(), 'kolux-mimo-code-child-attention-'))
    posts = []
    savedEnv = {}
