export function getStatusPluginLifecycleSource(): string[] {
  return [
    ...
    '    // immediately even when MiMo Code session lookup is slow or unavailable.',
    ...
    "  // Why: attention without MiMo Code's required sessionID cannot be",
    ...
    '    // Why: current MiMo Code emits canonical idle followed by deprecated',
