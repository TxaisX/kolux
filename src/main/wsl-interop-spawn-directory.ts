 ...
 * `lpCurrentDirectory`, and NULL means *inherit the parent's*. Kolux launched by
 * `kolux-ide` from a WSL shell inherits `\\wsl.localhost\<distro>\...\<worktree>`
