...
export function createWorktreePollerWindowVisibility(
  ...
  // that has NEVER been shown is either headless (KOLUX_E2E_HEADLESS keeps a live but
...
// churn to Kolux just to observe a handful of shallow paths. The replacements
...
// Kolux's own worktree operations notify the renderer directly.
