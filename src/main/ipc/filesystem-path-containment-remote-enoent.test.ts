 ...
 * `ENOENT: no such file or directory, lstat '/home/neil/projects/kolux-test1234'`.
 *
...
describe('isENOENT across the SSH relay boundary', () => {
  ...
  it('recognises it through the IPC wrapper the renderer sees', () => {
    const throughIpc = new Error(
      "Error invoking remote method 'worktrees:create': Error: ENOENT: no such file or directory, lstat '/home/neil/projects/kolux-test1234-3'"
    )
