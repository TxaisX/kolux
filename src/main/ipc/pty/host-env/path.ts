...
export function promoteAgentTeamsShimPath(
  ...
  if (!env?.KOLUX_AGENT_TEAMS_TEAM_ID) {
    return
  }
  ...
  // Why: host env injection prepends Kolux's shims; Claude Agent Teams must still resolve our fake tmux before any real tmux.
