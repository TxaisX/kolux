export const ANTIGRAVITY_HOOK_BUNDLE_NAME = 'kolux-status'
...
// only "ask" defers to the user's permission config — "allow" would auto-approve every tool call Kolux observes.
