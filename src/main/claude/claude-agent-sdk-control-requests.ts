...
/**
 * Run one native Query control method under Kolux's deadline and error classification.
 *
...
/** The native control surface Kolux drives, one method per Query control request. */
