...
const START_MARKER = '__KOLUX_LOGIN_SHELL_ENV_START__'
const END_MARKER = '__KOLUX_LOGIN_SHELL_ENV_END__'
...
/** Resolves the environment seen by commands launched from Kolux's profile-loading terminal shell. */
