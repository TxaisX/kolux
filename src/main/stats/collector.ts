...
// through Kolux. Without a cap, a heavily-used instance accumulates thousands of
...
// after configureDevUserDataPath() but before app.setName('Kolux'). See the
...
export function initStatsPath(): void {
  _statsFile = join(app.getPath('userData'), 'kolux-stats.json')
}
