 ...
 * reported koluxd's version for both would hide exactly that.
 */
...
// Leave history sessions marked "unclean" so a daemon crash while Kolux is closed stays recoverable.
