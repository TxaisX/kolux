...
async function main(): Promise<void> {
  ...
  const e2eProbeFile = process.env.KOLUX_E2E_LOGIN_SESSION_PROBE_FILE
...
// load check — see config/scripts/build-koluxd.mjs).
const isDirectExecution = !process.env.VITEST && !process.env.KOLUX_DAEMON_ENTRY_LOAD_CHECK
