...
describe('CodexRuntimeHomeService', () => {
        ...
        codexManagedAccounts: [
          {
            ...
            wslDistro: 'Ubuntu',
            wslLinuxHomePath: '/home/alice/.local/share/kolux/codex-accounts/ubuntu/home',
  ...
  it('passes the Linux source config directory for mounted-drive WSL homes', async () => {
    ...
    try {
      ...
      // Why: getWslHome already returns the drvfs-mounted home as its Windows drive
      // spelling — join onto it directly rather than forcing a wsl.localhost UNC form.
