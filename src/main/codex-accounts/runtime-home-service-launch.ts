...
export abstract class CodexRuntimeHomeLaunch extends CodexRuntimeHomeRouting {
  protected initializeLastSyncedState(): void {
    ...
    // Why: WSL-managed homes never touch host ~/.codex; treating one as "last synced" makes cold start mangle host auth Kolux never touched.
  ...
  prepareForCodexLaunch(
    ...
    if (selfContainedAccount) {
      ...
      // system default without injecting a path Kolux cannot prove it owns.
    }
