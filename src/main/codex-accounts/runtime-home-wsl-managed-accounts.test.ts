...
describe('CodexRuntimeHomeService', () => {
      ...
      codexManagedAccounts: [
        {
          ...
          wslDistro: 'Ubuntu',
          wslLinuxHomePath: '/home/alice/.local/share/kolux/codex-accounts/account-1/home',
      ...
      createSettings({
        codexManagedAccounts: [
          ...
          },
          {
            ...
            managedHomeRuntime: 'wsl',
            wslDistro: 'Ubuntu',
            wslLinuxHomePath: '/home/alice/.local/share/kolux/codex-accounts/account-2/home',
  ...
  it('launches and drains a mounted-drive WSL account through its distro path', async () => {
    ...
    const linuxHomePath = '/mnt/c/Users/alice/kolux/codex-accounts/drive-account/home'
    vi.doMock('../wsl', () => ({
      getDefaultWslDistro: () => 'Ubuntu',
        ...
        codexManagedAccounts: [
          {
            ...
            managedHomePath: 'C:\\Users\\alice\\kolux\\codex-accounts\\drive-account\\home',
            managedHomeRuntime: 'wsl',
            wslDistro: 'Ubuntu',
