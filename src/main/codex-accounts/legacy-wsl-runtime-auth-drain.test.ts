...
describe('legacy WSL runtime auth drain', () => {
  ...
  it('promotes fresher auth guest-side while a legacy pane remains', async () => {
    ...
    const resolveDestination = vi.fn(() => ({
      ...
      linuxHomePath: '/home/alice/.local/share/kolux/codex-accounts/account-1/home'
    }))
    ...
    expect(runWslProcessMock.mock.calls[1]?.[0].args.slice(3)).toEqual([
      '/home/alice/.local/share/kolux/codex-accounts/account-1/home',
      expect.any(String),
      expect.any(String),
      '1',
      '0',
  ...
  it('marks an absent legacy home complete after every legacy pane exits', async () => {
    ...
    expect(runWslProcessMock.mock.calls[1]?.[0].args).toEqual([
      '/home/alice/.local/share/kolux/codex-runtime-home/home',
      '/home/alice/.local/share/kolux/codex-runtime-home/active/wsl/home',
      '/home/alice/.local/share/kolux/codex-runtime-home/direct-home-auth-drain-v1.json'
    ])
  })
