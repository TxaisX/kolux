...
// (user, agent, or Kolux's own Fetch action) imports the fork's entire branch set --
...
// the branches Kolux actually knows about (see #17828).
//
// The tracked-branch refspec source carries a trailing `*` (`refs/heads/<branch>*`)
// rather than being a literal exact match. This is deliberate: Kolux is terminal-centric
