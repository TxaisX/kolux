 ...
 *
 * Probes are always secondary to Kolux automation list and mutation traffic, so
...
export class ExternalAutomationProbeScheduler {
  ...
  /** Held for the duration of Kolux list/mutation work; queued probes wait behind it. */
