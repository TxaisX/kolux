...
const MANAGED_HOME_ROLLOUT =
  '/Users/ada/Library/Application Support/kolux/codex-runtime-home/home/sessions/2026/07/01/rollout-2026-07-01T10-00-00-019f0000-1111-7222-8333-444444444444.jsonl'
const MANAGED_HOME = '/Users/ada/Library/Application Support/kolux/codex-runtime-home/home'
...
describe('dedupeCodexRolloutFileAliases', () => {
  ...
  it('prefers the managed runtime home over other non-default homes', () => {
    const managed = {
      agent: 'codex',
      path: `\\\\wsl$\\Ubuntu\\home\\ada\\.local\\share\\kolux\\codex-runtime-home\\home\\sessions\\2026\\07\\01\\rollout-2026-07-01T10-00-00-019f0000-1111-7222-8333-444444444444.jsonl`,
      codexHome: '\\\\wsl$\\Ubuntu\\home\\ada\\.local\\share\\kolux\\codex-runtime-home\\home',
      hardlinkIdentity: '1:42'
    }
    const wslReal = {
      agent: 'codex',
  ...
  it('recognizes the managed runtime home with backslash separators', () => {
    const managed = {
      agent: 'codex',
      path: 'C:\\Users\\ada\\AppData\\Roaming\\kolux\\codex-runtime-home\\home\\sessions\\2026\\07\\01\\rollout-2026-07-01T10-00-00-019f0000-1111-7222-8333-444444444444.jsonl',
      codexHome: 'C:\\Users\\ada\\AppData\\Roaming\\kolux\\codex-runtime-home\\home',
  ...
  it('prefers a per-account self-contained home over other non-default homes', () => {
    const perAccount = {
      agent: 'codex',
      path: '/Users/ada/Library/Application Support/kolux/codex-accounts/019f0000-aaaa-bbbb/home/sessions/2026/07/01/rollout-2026-07-01T10-00-00-019f0000-1111-7222-8333-444444444444.jsonl',
      codexHome:
        '/Users/ada/Library/Application Support/kolux/codex-accounts/019f0000-aaaa-bbbb/home',
...
describe('dedupeCodexSessionsBySessionId', () => {
  ...
  it('prefers the managed runtime home over a WSL real home when no host real-home row exists', () => {
    const wslManaged = codexSession({
      sessionId: 'wsl-pair',
      filePath:
        '\\\\wsl$\\Ubuntu\\home\\ada\\.local\\share\\kolux\\codex-runtime-home\\home\\sessions\\rollout-a.jsonl',
      codexHome: '\\\\wsl$\\Ubuntu\\home\\ada\\.local\\share\\kolux\\codex-runtime-home\\home'
    })
  ...
  it('never collapses matching host and WSL session identities', () => {
    ...
    const wsl = codexSession({
      sessionId: 'shared-id',
      filePath: `\\\\wsl.localhost\\Ubuntu\\home\\ada\\.local\\share\\kolux\\codex-runtime-home\\home\\sessions\\${rolloutName}`,
      codexHome:
        '\\\\wsl.localhost\\Ubuntu\\home\\ada\\.local\\share\\kolux\\codex-runtime-home\\home'
    })
