...
export type CreateCloudLinkedKoluxProfileRecordResult = KoluxProfileListState & {
...
function toLocalProfile(profile: KoluxProfileSummary, now: number): KoluxProfileSummary {
...
function reconcileCurrentArtifactCloudCleanup(
  profileId: string,
  userDataPath: string,
  currentCloud: KoluxProfileCloudSummary | undefined
): void {
...
export function createCloudLinkedKoluxProfileRecord(
  cloud: KoluxProfileCloudSummary,
  args: { name?: string },
  userDataPath: string
): CreateCloudLinkedKoluxProfileRecordResult {
...
export function linkKoluxProfileToCloud(
  profileId: string,
  cloud: KoluxProfileCloudSummary,
  userDataPath: string
): KoluxProfileListState {
...
export function unlinkKoluxProfileFromCloud(
  profileId: string,
  userDataPath: string
): KoluxProfileListState {
  const index = loadOrCreateProfileIndex(userDataPath)
