...
// The base URL is overridable via the same env var the CLI honours so Kolux
 ...
 * Kolux must NEVER refresh or rewrite that file — a rotated refresh token would
