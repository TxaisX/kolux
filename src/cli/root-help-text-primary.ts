export const ROOT_HELP_TEXT_PRIMARY = [
  'kolux',
  '',
  'Usage: kolux <command> [options]',
  '',
  'Startup:',
  '  open                      Launch Kolux and wait for the runtime to be reachable',
  '  serve                     Start a headless Kolux runtime server',
  '  status                    Show app/runtime/graph readiness',
  '',
  'Diagnostics:',
  '  diagnostics memory        Collect a memory snapshot for Kolux and managed terminals',
  '',
  'Agent Discovery:',
  ...
  '  skills list               List version-matched skill guides bundled with this Kolux CLI',
  '  skills get                Print a version-matched skill guide as Markdown',
  '  skills install            Install bundled Kolux skills globally via the community skills CLI',
  '  skills update             Update already-installed Kolux skills via the community skills CLI',
  '',
  'Hosts:',
  '  host list                 List targetable machines and how to name each one',
  '',
  'Environments:',
  '  environment add           Save a remote Kolux runtime from a pairing code',
  '  environment list          List saved remote Kolux runtimes',
  '  environment show          Show one saved remote Kolux runtime',
  '  environment rm            Remove a saved remote Kolux runtime',
  '',
  'Environment Recipes:',
  '  vm recipe doctor          Validate a per-workspace environment recipe',
  '',
  'Automations:',
  '  automations list          List scheduled Kolux automations',
  '  automations show          Show one Kolux automation',
  '  automations create        Create a scheduled Kolux automation',
  '  automations edit          Edit a Kolux automation',
  '  automations remove        Remove a Kolux automation and its run history',
  '  automations run           Run a Kolux automation now',
  '  automations runs          List automation run history',
  '',
  'Projects:',
  '  project list              List durable projects known to Kolux',
  ...
  '',
  'Repos:',
  '  repo list                 List repos registered in Kolux',
  '  repo add                  Add a project to Kolux by filesystem path',
  ...
  '',
  'Worktrees:',
  '  worktree list             List Kolux-managed worktrees',
  '  worktree show             Show one worktree',
  '  worktree current          Show the Kolux-managed worktree for the current directory',
  '  worktree create           Create a new Kolux-managed worktree',
  '  worktree set              Update Kolux metadata for a worktree',
  '  worktree rm               Remove a worktree from Kolux and git',
  '  worktree ps               Show a compact orchestration summary across worktrees',
  '',
  'Files:',
  '  file open                 Open a workspace file in the Kolux editor',
  '  file diff                 Open a workspace file diff in the Kolux editor',
  '  file open-changed         Open all git-changed files for a workspace',
  '',
  'Terminals:',
  '  terminal list             List live Kolux-managed terminals',
  ...
  '  emulator list             List available/running emulators (Kolux-managed + raw serve-sim)',
