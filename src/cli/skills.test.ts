...
describe('kolux skills CLI', () => {
  ...
  it('prints the resolved install command without running it for --dry-run', async () => {
    ...
    expect(stdoutText(stdoutSpy)).toBe(
      'npx --yes skills add https://github.com/TxaisX/kolux --skill alpha --global --agent claude-code --agent universal -y\n\n' +
  ...
  it('drops --global for --local in the dry-run command and JSON', async () => {
    ...
    expect(stdoutText(stdoutSpy)).toBe(
      'npx --yes skills add https://github.com/TxaisX/kolux --skill alpha --agent claude-code --agent universal -y\n\n' +
        'Rerun without --dry-run to install now.\n'
    )
  ...
  it('reports the command it is about to run on stderr', async () => {
    ...
    expect(stderrSpy).toHaveBeenCalledWith(
      'Running: npx --yes skills add https://github.com/TxaisX/kolux --skill alpha --global --agent claude-code --agent universal -y\n'
    )
  })
