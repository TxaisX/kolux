...
export const BROWSER_BASIC_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    usage:
      'kolux scroll --direction <up|down> [--amount <pixels>] [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'direction', 'amount', 'worktree']
  },
  {
    path: ['goto'],
    summary: 'Navigate the active browser tab to a URL',
    usage: 'kolux goto --url <url> [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'url', 'worktree']
  },
  {
    path: ['back'],
    summary: 'Navigate back in browser history',
    usage: 'kolux back [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'worktree']
  },
  {
    path: ['reload'],
    summary: 'Reload the active browser tab',
    usage: 'kolux reload [--worktree <selector>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'worktree']
  },
  {
    path: ['eval'],
    summary: 'Evaluate JavaScript in the browser page context',
    usage: 'kolux eval --expression <js> [--worktree <selector>] [--json]',
  ...
  },
  {
    ...
    usage:
      'kolux wait [--selector <sel>] [--timeout <ms>] [--text <text>] [--url <pattern>] [--load <state>] [--fn <js>] [--state <hidden|visible>] [--worktree <selector>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'selector',
      'timeout',
  ...
  },
  {
    ...
    usage:
      'kolux tab switch (--index <n> | --page <id>) [--worktree <selector>] [--focus] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'index', 'page', 'worktree', 'focus']
  },
  {
    path: ['tab', 'create'],
    summary: 'Create a new browser tab in the current worktree',
    usage: 'kolux tab create [--url <url>] [--worktree <selector>] [--profile <id>] [--json]',
  ...
  },
  {
    ...
    usage: 'kolux tab profile list [--json]',
  ...
  },
  {
    ...
    usage:
      'kolux tab profile create --label <name> [--scope <isolated|imported>] [--no-ua-spoof] [--json]',
