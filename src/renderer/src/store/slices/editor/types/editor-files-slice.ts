...
export type EditorFilesSlice = {
  ...
  /** Atomically retargets open editor sessions across a Kolux-owned move — one commit-only update migrating every path-derived id + all id-keyed state, no close/reopen. Returns collision/stale without mutating. */
