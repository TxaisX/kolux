...
vi.mock('@/lib/web-client-location', () => ({
  isWebClientLocation: () =>
    Boolean((globalThis as { __KOLUX_WEB_CLIENT__?: boolean }).__KOLUX_WEB_CLIENT__)
}))

const pairedWebFlag = globalThis as { __KOLUX_WEB_CLIENT__?: boolean }
