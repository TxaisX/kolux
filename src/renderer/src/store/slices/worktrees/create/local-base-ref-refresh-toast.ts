        ...
        }),
    {
      ...
      description: worktreeName
        ? translate(
            ...
            'Workspace "{{value0}}" was created from {{value1}}, but Kolux could not fast-forward local {{value2}}. {{value3}}',
            {
              value0: worktreeName,
        ...
        : translate(
            ...
            'Workspace created from {{value0}}, but Kolux could not fast-forward local {{value1}}. {{value2}}',
