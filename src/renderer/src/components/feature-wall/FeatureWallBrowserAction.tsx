...
// needs the Kolux CLI and browser skill, not Computer Use or orchestration.
...
// The grab→agent flow relies on the Kolux CLI and browser skill, so offer the same
// install action the Enable Kolux CLI step uses, scoped to just browser use.
