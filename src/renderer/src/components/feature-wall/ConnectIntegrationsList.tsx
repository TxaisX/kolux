      ...
      <div className="space-y-2.5">
        <IntegrationStep
          ...
          description={translate(
            ...
            'Connect a review provider so Kolux can show PR or MR status, checks, and reviews.'
          )}
          summary={
            <>
        ...
        <IntegrationStep
          ...
          title={translate(
            ...
            'Start agents on your tasks without leaving Kolux'
          )}
          description={translate(
            'auto.components.feature.wall.ConnectIntegrationsList.33b650af52',
            'Connect where your team tracks work. Kolux starts workspaces with the issue title, link, and context already attached.'
          )}
          summary={
