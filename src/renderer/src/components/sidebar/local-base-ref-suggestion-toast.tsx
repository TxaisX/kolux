    ...
    <div className="flex w-full flex-col gap-3">
      <p className="text-sm leading-5 text-popover-foreground/80">
        {translate(
          ...
          'Your new worktree is current, but local {{value0}} is {{value1}} {{value2}} behind, so AI diffs may compare to stale history. Let Kolux keep it up to date automatically. Change this anytime in',
          {
            value0: suggestion.localBranch,
