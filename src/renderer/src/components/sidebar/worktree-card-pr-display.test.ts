...
const pr: HostedReviewInfo = {
  ...
  title: 'Ready PR',
  state: 'open',
  url: 'https://github.com/TxaisX/kolux/pull/123',
  status: 'success',
...
const gitLabReview: HostedReviewInfo = {
  ...
  title: 'Ready MR',
  state: 'open',
  url: 'https://gitlab.com/TxaisX/kolux/-/merge_requests/321',
  status: 'success',
  updatedAt: '2026-05-13T00:00:00.000Z',
  mergeable: 'MERGEABLE'
}
...
const bitbucketReview: HostedReviewInfo = {
  ...
  state: 'open',
  url: 'https://bitbucket.org/TxaisX/kolux/pull-requests/789',
  status: 'success',
  updatedAt: '2026-05-13T00:00:00.000Z',
  mergeable: 'MERGEABLE'
}
...
describe('isCachedMergedBranchPRCurrentForWorktree', () => {
  const mergedPR: PRInfo = {
    ...
    title: 'Merged PR',
    state: 'merged',
    url: 'https://github.com/TxaisX/kolux/pull/55',
