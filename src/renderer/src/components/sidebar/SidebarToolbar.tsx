...
const WORKSPACE_BOARD_MOVED_HINT_STORAGE_KEY = 'kolux.workspaceBoardMovedHintSeen.v1'
...
const SidebarToolbar = React.memo(function SidebarToolbar({
  ...
  // translate() preserves Kolux's pseudo-localization behavior. Without it the
