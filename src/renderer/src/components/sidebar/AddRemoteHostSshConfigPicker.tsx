      ...
      <DialogHeader className="text-left">
        ...
        <DialogDescription>
          {translate(
            ...
            'Pick a host to fill the form, or add every new host to Kolux’s host list.'
          )}
        </DialogDescription>
      </DialogHeader>
          ...
          >
            {hosts.map((host) => (
              <li key={host.alias}>
                <button
                  type="button"
                  disabled={picksDisabled || host.alreadyInKolux}
                  className={cn(
                ...
                >
                  ...
                  {resolvingAlias === host.alias ? (
                    ...
                    >
                      {translate(
                        'auto.components.sidebar.AddRemoteHostDialog.sshConfigPickerInKolux',
                        'In Kolux'
                      )}
                    </Badge>
          ...
          {isBulkImporting
            ...
            : newHostCount > 0
              ? translate(
                  ...
                  'Add all {{value0}} to Kolux',
                  { value0: newHostCount }
                )
              : // Why: the remainder can be already-in-Kolux or merely tombstoned, so the
