...
export function ForgetSshWorkspaceDialog(): React.JSX.Element | null {
  ...
  // Remove Kolux's records only — never touches remote files, worktrees, or branches.
  ...
  const forgetDescription = translate(
    ...
    'Removes this workspace from Kolux only. Files, the Git worktree, and branches on {{host}} are left untouched.',
    { host: hostLabel }
  )
          ...
          <DialogDescription className="text-xs">
            {canReconnect
              ? translate(
                  ...
                  'The SSH host for this workspace is not connected. Reconnect to delete it on the remote too, or remove it from Kolux only.'
                )
              : translate(
