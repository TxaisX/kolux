            ...
            <div className="min-w-0 shrink space-y-0.5">
              ...
              <p className="text-xs text-muted-foreground">
                {translate(
                  ...
                  'Stops idle background agent terminals after the configured idle window and resumes supported sessions when you open them again. Agent sleep preserves launch options for agents started by Kolux. Manually started agents may resume with your current Kolux defaults. Experimental while we tune the safety model.'
                )}
              </p>
            </div>
            <SettingsSwitch
            ...
            <div className="ml-4 space-y-3 border-l border-border pl-4">
              <NumberField
                ...
                description={translate(
                  ...
                  'How many idle minutes a completed background agent must wait before Kolux can sleep it.'
                )}
