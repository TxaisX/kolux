  ...
  return {
    ...
    terminalQuickCommands: {
      ...
      description: translate(
        ...
        'Commands are saved on the selected Kolux host, then scoped globally or to a project setup. Commands from this device also remain available in remote workspaces.'
      )
    },
    workspaceDirectory: {
