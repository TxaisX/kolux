        ...
        <DialogHeader>
          ...
          <DialogDescription>
            {translate(
              ...
              'This deactivates {{value0}} and restores its previous immutable version. If that version requests different access or instructional content, Kolux will require another review.',
              { value0: plugin?.name ?? '' }
            )}
          </DialogDescription>
        </DialogHeader>
