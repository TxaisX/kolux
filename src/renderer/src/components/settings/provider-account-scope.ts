...
export function getProviderRateLimitScope(
  ...
  if (runtimeId) {
    return {
      ...
      description: translate(
        ...
        '{{value0}} API budget is fetched from the CLI on this remote server. Use Settings > Remote Kolux Servers > Advanced to view another default runtime budget.',
  ...
  return {
    ...
    description: translate(
      ...
      '{{value0}} API budget is fetched from the CLI on this desktop client. Use Settings > Remote Kolux Servers > Advanced to view server-owned budgets.',
      { value0: providerLabel }
    )
  }
}
