...
export function WslCliRegistration({
  ...
  const commandName = status?.commandName ?? 'kolux-ide'
              ...
              {loading
                ...
                : (status?.detail ??
                  translate(
                    ...
                    'Register `kolux-ide` in ~/.local/bin inside WSL.'
                  ))}
            </p>
          </div>
            ...
            <DialogDescription>
              {isEnabled
                ? translate(
                    ...
                    'This removes the WSL shell command. Kolux itself remains installed on Windows.'
                  )
                : translate(
                    'auto.components.settings.WslCliRegistration.7ee4e52b99',
                    'Kolux will register {{value0}} so the command works from WSL terminals.',
