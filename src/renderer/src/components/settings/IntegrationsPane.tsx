        ...
        <div className="space-y-1">
          ...
          <p className="text-xs text-muted-foreground">
            {translate(
              ...
              'Connect the source hosts Kolux can use for pull requests, merge requests, checks, and review status.'
            )}
          </p>
        </div>
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs text-muted-foreground">
            {translate(
              ...
              'Connect issue trackers Kolux can use to browse tasks and start workspaces with linked context.'
            )}
          </p>
        </div>
        <div className="space-y-3">
