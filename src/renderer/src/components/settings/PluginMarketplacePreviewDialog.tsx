              ...
              <div className="flex items-start gap-2 rounded-md border border-border bg-muted/50 px-3.5 py-3 text-sm leading-6">
                ...
                <span>
                  {translate(
                    ...
                    "Capabilities limit how this plugin uses Kolux's API. Its worker still runs as a normal process on this computer with full access to your files, network, and other processes."
                  )}
                </span>
              </div>
            ) : null}
            {blocked ? (
              <p className="rounded-md border border-destructive/30 bg-destructive/5 px-3.5 py-3 text-sm text-destructive">
                {translate(
                  ...
                  "Kolux's safety list blocks this plugin: {{value0}}",
