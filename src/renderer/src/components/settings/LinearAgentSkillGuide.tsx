          ...
          <div className="min-w-0 flex-1 space-y-0.5">
            ...
            <p className="text-xs text-muted-foreground">
              {translate(
                ...
                'Personal API key so Kolux can list issues and open linked workspaces.'
              )}
            </p>
          </div>
          <Button
            ...
            <div className="min-w-0 flex-1 space-y-0.5">
              ...
              <p className="text-xs text-muted-foreground">
                {translate(
                  ...
                  'Gives coding agents /kolux-linear for reading, updates, triage, and attaching pull or merge requests.'
                )}
              </p>
            </div>
          </div>
