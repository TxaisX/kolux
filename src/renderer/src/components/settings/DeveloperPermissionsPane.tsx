  ...
  },
  {
    ...
    get description() {
      return translate(
        ...
        "macOS names Kolux when the agents it runs read other apps' data, because Kolux is the responsible process for terminal commands. Grant this to Kolux to reduce those prompts. Then quit and reopen Kolux."
      )
    },
    get actionLabel() {
      return translate(
  ...
  },
  {
    ...
    get description() {
      return translate(
        ...
        "Allows terminals and development tools to connect to services on your local network. macOS does not report this permission's current status to Kolux."
      )
    },
    get actionLabel() {
      return translate(
...
export function DeveloperPermissionsPane({
  ...
  // back to Kolux, the chip should reflect the new status without a manual
        ...
        <div className="space-y-1">
          <div className="flex items-center gap-2 text-sm font-medium">
            ...
            {translate(
              ...
              "Terminal tools inherit Kolux's macOS privacy envelope."
            )}
          </div>
          <p className="text-xs text-muted-foreground">
            {translate(
              'auto.components.settings.DeveloperPermissionsPane.6326a4c5cc',
              'Use these controls when a CLI, local app, or automation tool needs macOS privacy access. Kolux does not ask at startup.'
            )}
          </p>
        </div>
