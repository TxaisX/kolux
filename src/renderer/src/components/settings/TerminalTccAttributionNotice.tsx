 ...
 * updates replace the bundle), Accessibility/Automation grants on Kolux silently stop
        ...
        <div className="min-w-0 space-y-1">
          ...
          <p className="text-xs leading-snug">
            {translate(
              ...
              'The terminal daemon was started by a Kolux install that no longer exists, so macOS can’t attribute its commands to Kolux — Accessibility and Automation grants are silently ignored (osascript fails with error -25211). Restarting the daemon fixes this; running terminal sessions will close.'
            )}
          </p>
        </div>
      </div>
