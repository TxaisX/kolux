...
export const getNotificationsPaneSearchEntries = createLocalizedCatalog(() => [
  {
    ...
    description: translate(
      ...
      'Master switch for Kolux desktop notifications.'
    ),
    keywords: [
  ...
  },
  {
    ...
    description: translate(
      ...
      'Avoid notifying when Kolux is focused on the active worktree.'
    ),
    keywords: [
      ...translateSearchKeyword(
        'auto.components.settings.notifications.search.ca8faa40d7',
  ...
  },
  {
    ...
    description: translate(
      ...
      'Choose the built-in, system, or local audio file Kolux plays for desktop notifications.'
    ),
    keywords: [
      ...translateSearchKeyword(
        'auto.components.settings.notifications.search.ca8faa40d7',
