      ...
      <div className="space-y-3 pb-1 pl-5 pt-1">
        <p className="max-w-2xl text-xs leading-5 text-muted-foreground">
          {translate(
            ...
            'Load plugins directly from folders on this computer while you develop them. Dev plugins still require permission review. Workers run on this desktop host; SSH workspace actions route through Kolux, so paths here are desktop paths.'
          )}
        </p>
