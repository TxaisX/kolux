...
const EMULATOR_EXAMPLE_PROMPTS = [
  'Using Kolux CLI, attach to the active iPhone simulator, sign in with the test account, complete onboarding, and tell me where the flow feels confusing.',
  'With Kolux CLI, run through the mobile checkout flow from product search to confirmation, capture any broken screens, and summarize the exact step that fails.',
  'Using Kolux CLI, grant camera permission, scan a test QR code or inject a camera fixture, finish the account-linking flow, and report whether the app reaches the success state.'
] as const
    ...
    >
      ...
      <p className="mt-1 text-xs text-muted-foreground">
        {translate(
          ...
          'Paste any of these into Claude Code, Codex, or another agent in a project where the Kolux CLI skill is installed.'
        )}
      </p>
