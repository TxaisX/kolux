              ...
              <span>
                {plugin.hasWorker
                  ? translate(
                      ...
                      "These permissions limit how the plugin uses Kolux's API. Its worker still runs as a normal process on your computer with full access to your files, network, and other processes."
                    )
