...
const EXAMPLE_PROMPTS: string[] = [
  'Using Kolux CLI, open https://github.com/notifications and click the first unread pull request.',
  "Take a screenshot of my open Linear board with the Kolux CLI and tell me what's blocked.",
  'With Kolux CLI, go to our staging app, log in (my cookies are imported), and verify the checkout flow works.'
]
