...
const AGENT_PROMPT =
  'Use the kolux-per-workspace-env skill to set up a per-workspace environment for this repo.'
        ...
        <ul className="space-y-2">
          <WhatItem
            text={translate(
              ...
              'Writes the recipe & scripts for your provider — connected over a Kolux server or SSH.'
            )}
          />
          <WhatItem
            text={translate(
          ...
          <div className="min-w-0 space-y-0.5">
            ...
            <p className="text-xs text-muted-foreground">
              {translate(
                ...
                'Recipes from kolux.yaml and enabled plugins show up here, ready to launch a workspace on.'
              )}
            </p>
          </div>
          <Button
