...
export const getGeneralWorkspaceSearchEntries = createLocalizedCatalog(() => [
  ...
  },
  {
    ...
    description: translate(
      ...
      'Choose whether worktrees created outside Kolux appear by default.'
    ),
    keywords: [
...
export const getGeneralCliSearchEntries = createLocalizedCatalog(() => [
  {
    title: translate('auto.components.settings.general.search.327e3fa70d', 'Kolux CLI'),
    description: translate(
      'auto.components.settings.general.search.ca529079bf',
      'Register or remove the Kolux CLI command.'
    ),
    keywords: [
  ...
  },
  {
    ...
    description: translate(
      ...
      'Install the Kolux skill so agents know to use the Kolux CLI.'
    ),
    keywords: [
