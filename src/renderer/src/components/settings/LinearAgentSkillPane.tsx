...
import { KOLUX_LINEAR_SKILL_NAME } from '@/lib/agent-feature-install-commands'
  ...
  return (
    <SearchableSetting
      ...
      description={translate(
        ...
        'How Linear works in Kolux: browse issues, start linked workspaces, and let agents update tickets with /kolux-linear.'
      )}
    ...
    >
      ...
      <SkillUsageExamplesSection
        ...
        slashCommand={`/${KOLUX_LINEAR_SKILL_NAME}`}
      />
