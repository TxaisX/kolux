        ...
        description:
          githubTarget && activeReview.provider === 'github'
            ? translate(
                ...
                'Review the prompt before starting an agent. After the prompt is delivered, Kolux resolves the selected host threads and replies to comments it cannot resolve.'
              )
            : translate(
                'auto.components.right.sidebar.ChecksPanel.abf59262fb',
                'Review and edit the full command input before starting an agent.'
