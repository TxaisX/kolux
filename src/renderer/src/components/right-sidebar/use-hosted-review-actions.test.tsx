...
const prRepo = { host: 'github.com', owner: 'TxaisX', repo: 'kolux-sta1015-sandbox' }
...
describe('useHostedReviewActions', () => {
  ...
  it('gates runtime-owned ready mutations on the host capability', async () => {
    ...
    expect(runtimeRpcMocks.assertRuntimeEnvironmentCapability).toHaveBeenCalledWith(
      ...
      expect.stringContaining('newer Kolux server')
    )
    expect(runtimeRpcMocks.callRuntimeRpc).toHaveBeenCalledWith(
      { kind: 'environment', environmentId: 'env-1' },
      'github.markPRReadyForReview',
        ...
        entries: [
          {
            ...
            number: 1014,
            title: 'Models',
            url: 'https://github.com/TxaisX/kolux/pull/1014',
            state: 'open',
          ...
          },
          {
            ...
            number: 1015,
            title: 'API',
            url: 'https://github.com/TxaisX/kolux/pull/1015',
            state: 'open',
            checksStatus: 'success',
            mergeable: 'MERGEABLE'
          },
          {
            ...
            number: 1016,
            title: 'UI',
            url: 'https://github.com/TxaisX/kolux/pull/1016',
            state: 'open',
            checksStatus: 'success',
            mergeable: 'MERGEABLE'
          }
