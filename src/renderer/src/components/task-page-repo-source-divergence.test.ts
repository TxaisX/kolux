...
describe('hasDivergentSources', () => {
    ...
    expect(
      hasDivergentSources(
        state({
          ...
          prs: { owner: 'acme', repo: 'kolux', host: 'github.com' }
        })
      )
    ).toBe(true)
  })
  ...
  it('is false when issues and PRs share an owner/repo', () => {
    expect(
      hasDivergentSources(
        state({
          issues: { owner: 'acme', repo: 'kolux', host: 'github.com' },
          prs: { owner: 'acme', repo: 'kolux', host: 'github.com' }
        })
      )
    ).toBe(false)
...
describe('hasUpstreamCandidateDivergence', () => {
    ...
    expect(
      hasUpstreamCandidateDivergence(
        state({
          ...
          upstreamCandidate: { owner: 'acme', repo: 'kolux', host: 'github.com' }
        })
      )
    ).toBe(true)
  })
  ...
  it('is false when origin and upstream candidates match', () => {
    expect(
      hasUpstreamCandidateDivergence(
        state({
          originCandidate: { owner: 'acme', repo: 'kolux', host: 'github.com' },
          upstreamCandidate: { owner: 'acme', repo: 'kolux', host: 'github.com' }
        })
      )
    ).toBe(false)
