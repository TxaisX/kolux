    ...
    <div className="mp-intro-shell">
      <div className="mp-eyebrow-row">
        <span className="mp-eyebrow">
          {translate('auto.components.mobile.MobileHero.5410d55d79', 'Kolux Mobile')}
        </span>
      </div>
      <h1 className="mp-h1">
        {translate(
      ...
      <p className="mp-lead">
        {translate(
          ...
          "Control Kolux from your phone. Check on agents, review changes, and kick off tasks while you're away from your desk."
        )}
      </p>
      <div
