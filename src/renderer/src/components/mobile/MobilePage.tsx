...
export default function MobilePage(): React.JSX.Element {
  ...
  const signedIn = useAppStore((state) => state.koluxProfileAuthStatus?.state === 'connected')
  const refreshAuthStatus = useAppStore((state) => state.fetchKoluxProfileAuthStatus)
