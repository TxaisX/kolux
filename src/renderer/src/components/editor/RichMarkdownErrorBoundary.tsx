...
// 18 to unmount the entire renderer subtree, blacking out the whole Kolux
        ...
        <div className="flex h-full min-h-0 flex-col items-center justify-center gap-3 px-6 text-center text-sm text-muted-foreground">
          <div>
            {translate(
              ...
              'The rich markdown editor hit an unexpected error and was reset to keep the rest of Kolux responsive.'
            )}
          </div>
