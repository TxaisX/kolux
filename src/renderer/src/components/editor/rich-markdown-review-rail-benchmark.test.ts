...
// Run: KOLUX_REVIEW_RAIL_BENCH=1 pnpm test src/renderer/src/components/editor/rich-markdown-review-rail-benchmark.test.ts
...
it.skipIf(process.env.KOLUX_REVIEW_RAIL_BENCH !== '1')(
