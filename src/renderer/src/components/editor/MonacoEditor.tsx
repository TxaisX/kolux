  ...
  return (
    ...
    >
      ...
      <Editor
        ...
        language={language}
        // Why: defaultValue, not controlled value — Kolux owns post-mount content sync; a controlled path would double setValue.
        ...
        path={filePath}
        // Why: Kolux owns cursor/scroll restoration, so disable @monaco-editor/react's competing view-state Map.
        saveViewState={false}
        keepCurrentModel
      />
