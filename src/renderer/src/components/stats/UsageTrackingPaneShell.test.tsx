    ...
    <UsageTrackingPaneShell
      ...
      filterSections={[
        <UsageFilterRadioGroup
          ...
          value="kolux"
          options={[
            { value: 'kolux', label: 'Kolux worktrees only' },
      ...
      selectionSummary="Kolux worktrees only • Last 7 days"
...
describe('UsageTrackingPaneShell', () => {
  ...
  it('renders the empty state and wires header actions', async () => {
    ...
    expect(screen.getByText('Kolux worktrees only • Last 7 days')).toBeInTheDocument()
