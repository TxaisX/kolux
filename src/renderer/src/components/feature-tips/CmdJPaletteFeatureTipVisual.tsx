...
export function CmdJPaletteFeatureTipVisual(): JSX.Element {
  ...
  useEffect(() => {
    ...
    // Why: this tip may remain open while Kolux is idle. Play the demo once,
          ...
          <div className="h-5 min-w-0 flex-1 overflow-hidden text-[13px] leading-5 text-foreground/90">
            <span className="block truncate">
              ...
              {!reducedMotion && (phase === 'open' || phase === 'typing') ? (
                // Why: this tip can sit open while Kolux is idle; keep the
              ...
              >
                <span className="flex w-4 shrink-0 items-center justify-center">
                  {result.status === 'done' ? (
                    ...
                    // Why: this tip can stay mounted while Kolux is idle; mirror
