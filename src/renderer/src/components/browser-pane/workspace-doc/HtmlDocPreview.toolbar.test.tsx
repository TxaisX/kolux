...
const MARKUP_DRAW_HINT_SEEN_KEY = 'kolux.browser.markup-draw-hint-seen'
...
vi.mock('@/lib/doc-preview-grants', () => ({
  ...
  ensureDocPreviewGrant: () =>
    Promise.resolve({
      grantId: GRANT_ID,
      url: `kolux-preview://${GRANT_ID}/${ENTRY_RELATIVE_PATH}`
    }),
