        ...
        <DialogHeader className="gap-3">
          ...
          <DialogDescription className="text-xs leading-5">
            {translate(
              ...
              'Kolux could not save this terminal session because local storage is full or not writable. Open the disk space analyzer to find workspace storage you can clean up.'
            )}
          </DialogDescription>
        </DialogHeader>
