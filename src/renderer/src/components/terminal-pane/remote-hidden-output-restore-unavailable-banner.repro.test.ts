...
//   "[Kolux skipped hidden terminal output because main recovery was unavailable.]"
//   printed into a live remote-runtime agent pane.
//
// Topology modeled (renderer contract level, per reproduce-kolux-remote-server-issues):
