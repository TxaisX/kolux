...
describe('handleTerminalFileDrop', () => {
  ...
  it('uploads client-local drops into the active runtime before pasting paths', async () => {
      ...
      results: [
        {
          ...
          status: 'imported',
          destPath: '/remote/repo/.kolux/drops/logo.png',
          kind: 'file',
          renamed: false
        }
      ]
    ...
    expect(mocks.importExternalPathsToRuntime).toHaveBeenCalledWith(
      ...
      ['/Users/me/logo.png'],
      '/remote/repo/.kolux/drops',
      { assertCurrent: expect.any(Function) }
    )
    expect(sendInput).toHaveBeenCalledWith(
      wrapTerminalBracketedPasteText('/remote/repo/.kolux/drops/logo.png')
    )
  ...
  it('uses Windows shell paths for forward-slash UNC runtime worktrees', async () => {
      ...
      results: [
        {
          sourcePath: '/Users/me/logo.png',
          status: 'imported',
          destPath: '//server/share/repo\\.kolux\\drops\\logo.png',
          kind: 'file',
          renamed: false
        }
      ]
    ...
    expect(mocks.importExternalPathsToRuntime).toHaveBeenCalledWith(
      ...
      ['/Users/me/logo.png'],
      '\\\\server\\share\\repo\\.kolux\\drops',
      { assertCurrent: expect.any(Function) }
    )
    expect(sendInput).toHaveBeenCalledWith(
      wrapTerminalBracketedPasteText('\\\\server\\share\\repo\\.kolux\\drops\\logo.png')
    )
  })
  ...
  it('uploads to the worktree owner runtime instead of the focused runtime', async () => {
      ...
      results: [
        {
          ...
          status: 'imported',
          destPath: '/remote/repo/.kolux/drops/spec.pdf',
          kind: 'file',
          renamed: false
        }
      ]
    ...
    expect(sendInput).toHaveBeenCalledWith('/remote/repo/.kolux/drops/spec.pdf ')
  })
