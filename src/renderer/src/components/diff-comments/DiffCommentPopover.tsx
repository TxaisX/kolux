...
export function DiffCommentPopover({
  ...
  return (
    <div
      ref={popoverRef}
      className="kolux-diff-comment-popover"
    ...
    >
      {/* Content */}
      <div className="kolux-diff-comment-content-col" style={{ gap: '8px' }}>
        <div id={labelId} className="kolux-diff-comment-popover-label">
          {title ??
