...
import { useFocusedWorkspacePane, useWorkspaceComposerTargets } from './use-workspace-composer-targets'
...
export function WorkspaceComposer({ worktreeId }: { worktreeId: string }): React.JSX.Element {
  ...
  const handleSend = useCallback(() => {
    ...
    const current = resolveRunningAgentSendTarget(useAppStore.getState(), worktreeId, resolvedPaneKey)
