 ...
 * wrong in a way the update cannot fix — an edited copy, one Kolux could not read.
 *
...
export function groupSkillFreshness(
  ...
  for (const [name, entries] of byName) {
    ...
    // row would assert Kolux considered an update it never could. Locations below are still
