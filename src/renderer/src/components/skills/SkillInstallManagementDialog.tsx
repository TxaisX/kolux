    ...
    try {
      ...
      setError(
        translate(
          ...
          'Kolux could not inspect managed installs on this machine.'
        )
      )
    } finally {
      if (generation === loadGeneration.current) {
        ...
        setError(
          operation.status === 'reconnect-required'
            ? translate(
                ...
                'Reconnect your Kolux account to load version history.'
              )
            : operation.message
        )
        return
    ...
    try {
          ...
          setError(
            operation.status === 'reconnect-required'
              ? translate(
                  ...
                  'Reconnect your Kolux account before changing versions.'
                )
              : operation.message
          )
          return
      ...
      setError(
        translate(
          ...
          'Kolux could not verify the requested version.'
        )
      )
    } finally {
    ...
    try {
      ...
      setError(
        translate(
          ...
          'Kolux could not safely remove this skill.'
        )
      )
    } finally {
      setBusy(false)
