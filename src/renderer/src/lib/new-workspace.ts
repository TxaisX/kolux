...
// Why: when a repo has no `kolux.yaml` issueCommand and no per-user override,
...
function getDefaultTabCommandPreview(yamlHooks: KoluxHooks | null): string {
 ...
 * their `kolux.yaml` / `.kolux/issue-command` yet.
 */
