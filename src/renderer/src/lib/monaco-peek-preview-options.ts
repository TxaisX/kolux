...
type ReferenceWidgetConstructor = {
  prototype: ReferenceWidgetInstance & {
    __koluxPeekPreviewOptionsInstalled?: true
  }
}

function applyPeekReferencesPreviewOptions(editor: PeekPreviewEditor | undefined): void {
  // Why: Monaco embedded editors inherit Kolux's full-editor options first.
...
export function installMonacoPeekReferencesPreviewOptions(
  ...
  if (prototype.__koluxPeekPreviewOptionsInstalled) {
    return
  }
  ...
  prototype.__koluxPeekPreviewOptionsInstalled = true
}
