...
export const EMULATOR_MANUAL_LAUNCH_STARTED_EVENT = 'kolux:emulator-launch-started'
export const EMULATOR_MANUAL_LAUNCH_FAILED_EVENT = 'kolux:emulator-launch-failed'
