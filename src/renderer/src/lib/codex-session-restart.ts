...
export type CodexPaneScanResult = {
  ...
  /** Kolux launched Codex in this tab, so a shell foreground can still be reattach settle. */
 ...
 * Gated to Kolux-launched Codex panes so an account switch never spends the
 ...
 * baked into their environment. Without this, quitting Kolux before restarting a
