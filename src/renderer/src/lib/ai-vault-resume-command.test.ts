...
describe('ai vault resume command runtime', () => {
  ...
  it('copies a real-home Codex command that clears inherited homes in PowerShell', () => {
    ...
    expect(
      ...
      "Remove-Item Env:CODEX_HOME -ErrorAction SilentlyContinue; Remove-Item Env:KOLUX_CODEX_HOME -ErrorAction SilentlyContinue; Set-Location -LiteralPath 'C:\\Users\\alice\\repo'; codex 'resume' 'session one'"
    )
  })
  ...
  it('copies a real-home Codex command that clears inherited homes in cmd', () => {
    ...
    expect(
      ...
      'set "CODEX_HOME=" & set "KOLUX_CODEX_HOME=" & cd /d "C:\\Users\\alice\\repo" && codex "resume" "session one"'
    )
  })
  ...
  it('copies a real-home Codex command that clears inherited homes in POSIX shells', () => {
    ...
    expect(
      ...
      `cd '/home/alice/repo' && env -u CODEX_HOME -u KOLUX_CODEX_HOME codex 'resume' 'session one'`
    )
  })
