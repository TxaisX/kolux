...
export const APP_MENU_PASTE_EVENT = 'kolux-app-menu-paste'
...
export async function handleAppMenuPasteRequest({
  ...
  try {
    ...
    // control gained focus, not the text control Kolux already resolved.
  ...
  // Why: for text controls Kolux has already resolved ownership. Falling back
