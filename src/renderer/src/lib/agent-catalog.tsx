...
export const getAgentCatalog = createLocalizedCatalog((): AgentCatalogEntry[] => [
  ...
  },
  {
    ...
    cmd: 'openclaude',
    // Why: OpenClaude's published favicon has a padded 500px canvas; Kolux
  ...
  },
  {
    ...
    // the settings pane's "default command" hint aligns with what Kolux
  ...
  },
  {
    ...
    // suggestion that Kolux is looking for Windows' built-in `cmd.exe`.
    cmd: 'command-code',
