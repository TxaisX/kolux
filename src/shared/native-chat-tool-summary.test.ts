...
describe('describeToolInput', () => {
  ...
  it('keeps the filename when trimming an overlong path', () => {
    ...
    const path = `/Users/me/kolux/workspaces/kolux/sta-3333/src/shared/${'nested/'.repeat(4)}app.tsx`
  ...
  it('distinguishes two long paths that share a deep prefix', () => {
    const base = '/Users/me/kolux/workspaces/kolux/sta-3333-tool-summary/src/session/native'
