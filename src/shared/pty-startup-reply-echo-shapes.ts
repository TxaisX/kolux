...
/**
 * ECHOCTL carets EVERY control, not just ESC. Every OSC reply Kolux emits is ST-terminated
...
export function replyEchoProjections(
  ...
  if (ownerBackend === 'windows-conpty') {
    ...
    // was reported against — which is every OSC reply Kolux emits. Whether conhost leaves a
