...
describe('source-control AI action recipes', () => {
  ...
  it('lists supported agents when a text action uses an unsupported saved agent', () => {
    ...
    expect(
      ...
      ok: false,
      error:
        'Agent "aider" does not support Source Control AI commit messages. Supported agents: Claude, Codex, Pi, Amp, Cursor, Kimi, GitHub Copilot, Antigravity, or Custom command.'
    })
  })
})
