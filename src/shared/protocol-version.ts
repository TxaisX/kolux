...
// Why: declares the Kolux runtime RPC compatibility contract. Desktop,
...
export const ORCHESTRATION_WORKER_ROUTING_TIER_RUNTIME_CAPABILITY =
  'orchestration.worker-routing-tier.v1' as const
...
export const JIRA_USER_FIELDS_UPDATE_REQUIRED_MESSAGE =
  'Creating Jira issues with user fields requires a newer Kolux server. Update the server and try again.'
...
export const FILE_MUTATION_OWNERSHIP_UPDATE_REQUIRED_MESSAGE =
  'Remote file changes require a newer Kolux server. Update the HUB and try again.'
...
export const GITHUB_MARK_PR_READY_UPDATE_REQUIRED_MESSAGE =
  'Marking a pull request ready requires a newer Kolux server. Update the server and try again.'
...
export const GITLAB_READY_FOR_REVIEW_UPDATE_REQUIRED_MESSAGE =
  'Marking a merge request ready requires a newer Kolux server. Update the server and try again.'
...
export const AUTOMATION_LIST_HOST_SCOPE_UPDATE_REQUIRED_MESSAGE =
  'Filtering automations by host requires a newer Kolux server. Update the HUB and try again.'
