...
const INVENTORY: readonly InventoryGroup[] = [
  ...
  },
  {
    ...
    paths: [
      ...
      ['src/shared/terminal-title-agent-type.ts', 13]
    ]
  },
  {
    helper: 'titleHasAgentName',
  ...
  },
  {
    ...
    classification: 'evidence-producer',
    paths: [
      ['src/main/runtime/kolux-runtime-apply-tracked-pty-title.ts', 2],
      ['src/main/runtime/kolux-runtime-get-pty-record-for-pane-key.ts', 2],
      ['src/main/runtime/kolux-runtime-get-unpersisted-tracked-title-for-pty.ts', 2],
      ['src/main/runtime/kolux-runtime-maybe-hydrate-headless-from-renderer.ts', 2],
      ['src/main/runtime/kolux-runtime-record-agent-prompt-lifecycle-state.ts', 2],
  ...
  },
  {
    ...
    paths: [
      ...
      ['src/main/runtime/kolux-runtime-write-orchestration-pointer-pty.ts', 2]
    ]
  }
]
