...
// Why: a headed Kolux server keeps answering status.get after its workspace window
...
// window exists (kolux-runtime.ts:4806), so pairing it with a non-ready graph is the
