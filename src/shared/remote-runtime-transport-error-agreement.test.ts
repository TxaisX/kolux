...
const REQUEST_TRANSPORT_ERRORS: TransportErrorPair[] = [
  ...
  },
  {
    ...
    message: 'Could not connect to the remote Kolux runtime.'
  },
  {
  ...
  },
  {
    ...
    code: 'remote_runtime_unavailable',
    message: `Remote Kolux runtime closed the connection (1011: ${CLOSE_REASON.toString()}).`
  },
  {
    producer: 'remote-runtime-client.ts:289',
    code: 'invalid_runtime_response',
    message: 'Remote Kolux runtime returned an unexpected binary frame.'
  },
  {
    producer: 'remote-runtime-client.ts:310 / :693',
    code: 'invalid_runtime_response',
    message: 'Remote Kolux runtime returned an undecryptable frame.'
  },
  {
  ...
  },
  {
    ...
    code: 'remote_runtime_unavailable',
    message: 'Remote Kolux runtime request was released before it could be sent.'
  },
  {
    producer: 'remote-runtime-client.ts:459 / :829',
    code: 'invalid_runtime_response',
    message: 'Remote Kolux runtime returned a mismatched response id.'
  },
  {
  ...
  },
  {
    ...
    code: 'runtime_timeout',
    message: 'Timed out waiting for the remote Kolux runtime subscription to start.'
  },
  {
    producer: 'remote-runtime-client.ts:587',
    code: 'remote_runtime_unavailable',
    message: 'Remote Kolux runtime send buffer overflow; reconnecting.'
  },
  {
    producer: 'remote-runtime-client.ts:735',
    code: 'remote_runtime_unavailable',
    message: 'Remote Kolux runtime stopped responding; the stream connection was reset.'
  },
  {
    producer: 'remote-runtime-client.ts:842',
    code: 'invalid_runtime_response',
    message: 'Remote Kolux runtime returned binary data before authentication.'
  },
  {
    producer: 'remote-runtime-client.ts:852',
    code: 'invalid_runtime_response',
    message: 'Remote Kolux runtime returned an undecryptable binary frame.'
  },
  {
  ...
  producedPair(
    ...
    invalidRemoteRuntimeResponseError('Remote Kolux runtime returned an invalid E2EE auth frame.')
  ),
  producedPair(
...
const HOST_FORWARDED_TRANSPORT_ERRORS: TransportErrorPair[] = [
  ...
  },
  {
    producer: 'main/runtime/rpc/errors.ts:145 (STRUCTURED_RUNTIME_PASSTHROUGH_CODES)',
    code: 'invalid_runtime_response',
    message: 'Remote Kolux runtime returned an invalid response frame.'
  },
  {
    producer: 'main/runtime/rpc/errors.ts:145 (STRUCTURED_RUNTIME_PASSTHROUGH_CODES)',
...
const CODELESS_TRANSPORT_ERRORS: (TransportErrorPair & { recoverable: boolean })[] = [
  {
    ...
    message: 'Remote Kolux runtime is not connected.',
    recoverable: true
  },
  {
