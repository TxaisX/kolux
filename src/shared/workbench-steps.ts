// Per-step copy for the workbench tile in the Explore Kolux modal. Mirrors
...
export const WORKBENCH_STEPS: readonly WorkbenchStep[] = [
  ...
  },
  {
    ...
    name: 'Editor',
    subtitle: 'Editor',
    description: 'Use our Notion-style markdown editor to write notes without leaving Kolux.'
  },
  {
    id: 'browser',
    name: 'Browser',
