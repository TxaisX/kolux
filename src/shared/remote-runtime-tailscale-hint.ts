...
const REMOTE_RUNTIME_UNREACHABLE_RE =
  /could not connect to the remote kolux runtime|remote kolux runtime closed the connection|timed out (?:waiting for|while connecting to) the remote kolux runtime/i
