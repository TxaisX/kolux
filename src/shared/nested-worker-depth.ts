 ...
 * workers and those workers may not dispatch further — the behaviour Kolux
...
export const NESTED_WORKER_DEPTH_EXCEEDED_NEXT_STEPS: readonly string[] = [
  ...
  'To allow deeper nesting, open Settings → Orchestration in the Kolux desktop app and raise "Nested worker depth".'
]
