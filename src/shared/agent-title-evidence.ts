 ...
 *   anchored name  — a name in a position some grammar reserves for identity (Kolux's `- <agent>`
...
/** Catalog labels known to be emitted as terminal titles, not merely presented in Kolux's UI. */
...
/**
 * Kolux renders `<task text>… - <agent>` and owns the suffix; task text cannot reach past it.
