...
// a closed set (the native literal plus the labels Kolux synthesizes from Cursor hooks),
...
// Kolux's hook-synthesized spinner state, but only once a Cursor-owned title already
