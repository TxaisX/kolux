...
export const WSL_BROWSER_NETWORK_RELAY_DIR = '.kolux-wsl/browser-network'
export const WSL_BROWSER_NETWORK_RELAY_SENTINEL = 'KOLUX-WSL-BROWSER-NETWORK v1 READY\n'
