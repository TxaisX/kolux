 ...
 *
 * Kolux used to record one number and let every reader guess. That number is not
...
export type TerminalExitCause =
  /** Teardown was requested through Kolux — a close, a stop, a worktree removal. Not a failure. */
  | { kind: 'operator_close' }
