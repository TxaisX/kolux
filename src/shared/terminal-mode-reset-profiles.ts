...
// Why: SerializeAddon replays mode bits assuming reattach to a live TUI, but Kolux restores against a fresh shell with none, so stale bits (e.g. focus reporting rings the bell on click) must be reset.
