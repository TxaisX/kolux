...
// discipline sits between Kolux and the querying program can echo it straight back out as
...
//
// The reply is written IMMEDIATELY, in the caller's turn. Kolux used to withhold it until
