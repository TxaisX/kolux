...
const FISH_PROMPT_HANDOFF = `${ESC}[?2031h${ESC}[0m~/kolux ${ESC}[32m❯${ESC}[0m ${ESC}[?2031l`
...
const FISH_PROMPT_ACCEPT_CHUNKS: readonly string[] = [
  ...
  `${ESC}]0;~/kolux${BEL}${ESC}[m${ESC}]11;?${ESC}\\${ESC}[6n${ESC}[0c${ESC}[?2004h${ESC}[?2031h${ESC}[>4;1m${ESC}=`,
  // 2. The prompt itself.
  `${ESC}]133;A;click_events=1${BEL}~/kolux ❯ ${ESC}]133;B${BEL}${ESC}[K\r${ESC}[9C`,
