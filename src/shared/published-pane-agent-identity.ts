 ...
 * started — Kolux's launcher, a shell prompt, or a resumed session — and regardless of host.
 *
 ...
 * a user started by hand inside a Kolux WSL terminal has no launch record, no readable foreground
