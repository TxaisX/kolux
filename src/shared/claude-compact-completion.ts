// Claude's compact lifecycle, from Kolux's side.
//
...
// path. So PreCompact proves nothing and Kolux deliberately does not register it: mapping it to
...
// Stop, so Kolux must not touch the state.
