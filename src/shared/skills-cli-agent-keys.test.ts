...
describe('skills CLI agent keys', () => {
  ...
  it('covers every agent Kolux can detect', () => {
  ...
  it("follows Kolux's own evidence for the two non-obvious mappings", () => {
    ...
    // Why: Kolux detects trae via `traecli`, which tui-agent-config calls an alias
