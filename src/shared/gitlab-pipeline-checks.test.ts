    ...
    const jobs: GitLabPipelineJob[] = [
      {
        ...
        stage: 'test',
        status: 'failed',
        webUrl: 'https://gitlab.com/acme/kolux/-/jobs/1',
        duration: 12
      },
      {
        id: 2,
      ...
      },
      {
        ...
        stage: 'deploy',
        status: 'scheduled',
        webUrl: 'https://gitlab.com/acme/kolux/-/jobs/3',
        duration: null
      },
      {
        id: 4,
        ...
        webUrl: 'https://gitlab.com/acme/kolux/-/jobs/4',
        duration: null
      }
    ]
    ...
    expect(gitLabPipelineJobsToPRChecks(jobs)).toEqual([
      {
        ...
        status: 'completed',
        conclusion: 'failure',
        url: 'https://gitlab.com/acme/kolux/-/jobs/1',
        gitlabJobId: 1
      },
      {
        name: 'deploy: deploy',
      ...
      },
      {
        ...
        status: 'queued',
        conclusion: 'pending',
        url: 'https://gitlab.com/acme/kolux/-/jobs/3',
        gitlabJobId: 3
      },
      {
        ...
        status: 'queued',
        conclusion: 'pending',
        url: 'https://gitlab.com/acme/kolux/-/jobs/4',
        gitlabJobId: 4
      }
    ])
  })
