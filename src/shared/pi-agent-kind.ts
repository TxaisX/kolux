 ...
 * Kolux's managed extension installer needs to know which agent is being
...
export const SOURCE_AGENT_DIR_ENV_BY_KIND: Readonly<Record<PiAgentKind, string>> = {
  pi: 'KOLUX_PI_SOURCE_AGENT_DIR',
  omp: 'KOLUX_OMP_SOURCE_AGENT_DIR',
  'prime-agent': 'KOLUX_PRIME_AGENT_SOURCE_AGENT_DIR'
}
 ...
 * non-launch case (e.g. bare shells that may later invoke `pi`) where Kolux
