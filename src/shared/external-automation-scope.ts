...
export const EXTERNAL_AUTOMATION_SCOPE_CODES = {
  ...
  /** The SSH target is a Kolux implementation detail and stays out of user-facing surfaces. */
...
const SCOPE_MESSAGES: Record<ExternalAutomationScopeCode, string> = {
  ...
  [EXTERNAL_AUTOMATION_SCOPE_CODES.targetHidden]:
    'That host is managed by Kolux and does not expose external automations.',
