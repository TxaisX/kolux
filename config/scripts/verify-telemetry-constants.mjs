...
// Asserts that the telemetry compile-time constants — `KOLUX_BUILD_IDENTITY`
// and `KOLUX_POSTHOG_WRITE_KEY` — were substituted into the shipped binary.
...
function findAsar(rootDir) {
  ...
  // (`dist/mac/Kolux.app/Contents/Resources/app.asar` for x64,
  // `dist/mac-arm64/Kolux.app/Contents/Resources/app.asar` for arm64) because
...
// identifiers `KOLUX_BUILD_IDENTITY` and `KOLUX_POSTHOG_WRITE_KEY` with their
