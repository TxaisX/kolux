...
const ITERATIONS = Number.parseInt(process.env.KOLUX_AGENT_PROJECTION_BENCH_ITERATIONS ?? '400', 10)
const WARMUP = Number.parseInt(process.env.KOLUX_AGENT_PROJECTION_BENCH_WARMUP ?? '60', 10)

for (const [name, value] of [
  ['KOLUX_AGENT_PROJECTION_BENCH_ITERATIONS', ITERATIONS],
  ['KOLUX_AGENT_PROJECTION_BENCH_WARMUP', WARMUP]
]) {
