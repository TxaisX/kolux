...
export function getRequiredReleaseAssetNames(tag) {
  ...
  return [
    ...
    `kolux-ide_${version}_amd64.deb`,
    `kolux-ide_${version}_arm64.deb`,
    `kolux-ide-${version}.x86_64.rpm`,
    `kolux-ide-${version}.aarch64.rpm`,
    'kolux-windows-setup.exe',
    'kolux-windows-setup.exe.blockmap',
    `Kolux-${version}-mac.zip`,
    `Kolux-${version}-mac.zip.blockmap`,
    `Kolux-${version}-arm64-mac.zip`,
    `Kolux-${version}-arm64-mac.zip.blockmap`,
    'kolux-macos-x64.dmg',
    'kolux-macos-x64.dmg.blockmap',
    'kolux-macos-arm64.dmg',
    'kolux-macos-arm64.dmg.blockmap'
  ]
}
