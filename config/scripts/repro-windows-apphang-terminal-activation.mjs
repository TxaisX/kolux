...
async function main() {
  ...
  console.log(
    `[apphang-repro] issue=https://github.com/TxaisX/kolux/issues/6874 distro=${distro} gpuModes=${args.gpuModes.join(',')} cycles=${args.cycles}`
  )
  ...
  const payload = {
    issue: 'https://github.com/TxaisX/kolux/issues/6874',
    expect: args.expect,
    distro,
