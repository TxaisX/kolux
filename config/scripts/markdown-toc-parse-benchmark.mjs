...
const DOC_HEADINGS = Number.parseInt(process.env.KOLUX_TOC_BENCH_HEADINGS ?? '400', 10)
const PARAGRAPHS_PER_HEADING = Number.parseInt(process.env.KOLUX_TOC_BENCH_PARAS ?? '6', 10)
...
const CONTENT_CHANGES = Number.parseInt(process.env.KOLUX_TOC_BENCH_CHANGES ?? '200', 10)
const WARMUP = Number.parseInt(process.env.KOLUX_TOC_BENCH_WARMUP ?? '5', 10)

for (const [name, value] of [
  ['KOLUX_TOC_BENCH_HEADINGS', DOC_HEADINGS],
  ['KOLUX_TOC_BENCH_PARAS', PARAGRAPHS_PER_HEADING],
  ['KOLUX_TOC_BENCH_CHANGES', CONTENT_CHANGES],
  ['KOLUX_TOC_BENCH_WARMUP', WARMUP]
]) {
