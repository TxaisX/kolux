...
const ITERATIONS = Number.parseInt(process.env.KOLUX_HOOK_NORM_BENCH_ITERATIONS ?? '400', 10)
const WARMUP = Number.parseInt(process.env.KOLUX_HOOK_NORM_BENCH_WARMUP ?? '200', 10)

for (const [name, value] of [
  ['KOLUX_HOOK_NORM_BENCH_ITERATIONS', ITERATIONS],
  ['KOLUX_HOOK_NORM_BENCH_WARMUP', WARMUP]
]) {
