...
const CYCLES = Number.parseInt(process.env.KOLUX_EPOCH_BENCH_CYCLES ?? '20000', 10)
const PANES_PER_TAB = Number.parseInt(process.env.KOLUX_EPOCH_BENCH_PANES ?? '2', 10)

for (const [name, value] of [
  ['KOLUX_EPOCH_BENCH_CYCLES', CYCLES],
  ['KOLUX_EPOCH_BENCH_PANES', PANES_PER_TAB]
]) {
