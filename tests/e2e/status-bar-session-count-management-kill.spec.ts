 ...
 * daemon client (a previous app generation, `kolux serve`, a second Kolux client) this window's main
...
test.describe('Status bar CLI session count', () => {
  test('drops after Manage Sessions kills a foreign daemon session, popover never opened', async ({
    ...
    // A second daemon client, connected to the app's own daemon exactly as another Kolux client
