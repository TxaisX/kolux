...
// Run: KOLUX_TOOLTIP_PREVIEW=1 pnpm exec playwright test --config tests/playwright.config.ts \
...
test.skip(
  process.env.KOLUX_TOOLTIP_PREVIEW !== '1',
  'Preview only; run with KOLUX_TOOLTIP_PREVIEW=1'
)
