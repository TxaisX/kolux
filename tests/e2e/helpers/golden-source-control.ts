...
export const GOLDEN_GIT_AUTHOR_NAME = 'Kolux E2E'
export const GOLDEN_GIT_AUTHOR_EMAIL = 'kolux-e2e@example.invalid'
...
export function installPassingNodePreCommitHook(fixture: GoldenWorktree): string {
  const hooksPath = mkdtempSync(path.join(os.tmpdir(), 'kolux-e2e-git-hooks-'))
