...
export const FIXTURE_COMMENTS: PRComment[] = [
  {
    ...
    url: 'https://github.com/acme/kolux/pull/73#discussion_r101',
  ...
  },
  {
    ...
    url: 'https://github.com/acme/kolux/pull/73#issuecomment-102',
  ...
  },
  {
    ...
    url: 'https://github.com/acme/kolux/pull/73#discussion_r103',
...
export async function seedPRCommentsSidebarFixture(page: Page): Promise<PRCommentsSidebarSeed> {
  return page.evaluate(async (fixtureComments: PRComment[]) => {
    ...
    const pr: PRInfo = {
      ...
      state: 'open',
      url: `https://github.com/acme/kolux/pull/${prNumber}`,
    ...
    window.localStorage.setItem('kolux:pr-comment-presentation', 'cards')
