...
// KOLUX_E2E_TERMINAL_PARKING_DELAY_MS override to shrink the 30s hysteresis and
...
function createLocalRepoFixture() {
  ...
  git(repoPath, 'config', 'user.email', 'bench@kolux.local')
  git(repoPath, 'config', 'user.name', 'Kolux Bench')
