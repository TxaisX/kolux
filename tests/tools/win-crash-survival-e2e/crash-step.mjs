...
//
// GitHub #7742: when Kolux's main/renderer process died on Windows, the terminal
 ...
 * or image-named process, so a live user Kolux on the same box is never touched.
 */
