...
const TRANSCRIPT_DOMAIN = 'kolux-mobile-e2ee/v2/transcript'
const SALT_LABEL = utf8('kolux-mobile-e2ee/v2/salt\0')
const INFO_LABEL = utf8('kolux-mobile-e2ee/v2/session\0')
