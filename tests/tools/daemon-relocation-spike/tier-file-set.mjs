...
// irreducible core (Kolux.exe needs icu + snapshots even as node; the daemon
...
export function resolveTierFileSet(inv, tier) {
  ...
  // Core: exe + runtime data blobs live next to Kolux.exe in win-unpacked.
  addFile(inv.hostExe, 'Kolux.exe')
