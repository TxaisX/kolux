...
setlocal
set "SCRIPT_DIR=%~dp0"
set "LAUNCHER=%SCRIPT_DIR%kolux.exe"

if not exist "%LAUNCHER%" (
  echo Unable to locate the native Kolux CLI launcher at "%LAUNCHER%" 1>&2
  exit /b 1
)
...
:unsafe_body
echo kolux.cmd cannot safely forward orchestration message bodies. Use "%LAUNCHER%" instead. 1>&2
exit /b 2
